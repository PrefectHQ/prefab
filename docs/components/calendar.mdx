...
<ComponentPreview json={{"view":{"name":"calendar_1","type":"Calendar","mode":"single"}}} playground="H4sIAL1FuGkC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUnBNzUvNSEou4uGAsDU0uAEN5KCQ2AAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"name":"calendar_2","type":"Calendar","mode":"single","value":"2026-07-04T12:00:00.000Z"},"state":{"calendar_2":"2026-07-04T12:00:00.000Z"}}} playground="H4sIAL1FuGkC_8vMLcgvKlFISSxJLcnMTeVKK8rPVSgoSk1LTIovzdRLzgfK56XmlRQrZEJUOifmpOalJBZxccFYGmWJOaWptjAj9EAMDSMDIzMdBXMdBRNNTS4AnBVW-WUAAAA">
<CodeGroup>
```python Python icon="python"
import datetime
from prefab_ui.components import Calendar
...
<ComponentPreview json={{"view":{"name":"calendar_3","type":"Calendar","mode":"range","value":"{\"from\": \"2025-06-10T12:00:00.000Z\", \"to\": \"2025-06-20T12:00:00.000Z\"}"},"state":{"calendar_3":"{\"from\": \"2025-06-10T12:00:00.000Z\", \"to\": \"2025-06-20T12:00:00.000Z\"}"}}} playground="H4sIAL1FuGkC_8vMLcgvKlFISSxJLcnMTeVKK8rPVSgoSk1LTIovzdRLzgfK56XmlRQrZEJUOifmpOalJBZxccFYGlwKQJCbn5Jqq1SUmJeeqqQDFilLzClNta0Gs0FACWS2khXcLj0QQ8PIwMhUR8FMR8HQQFMHobYkH7dKI5jKWh0uTS4AZS440MIAAAA">
<CodeGroup>
```python Python icon="python"
import datetime
from prefab_ui.components import Calendar
...
<ComponentPreview json={{"view":{"name":"calendar_4","type":"Calendar","mode":"multiple","value":"[\"2025-06-10T12:00:00.000Z\", \"2025-06-15T12:00:00.000Z\", \"2025-06-22T12:00:00.000Z\"]"},"state":{"calendar_4":"[\"2025-06-10T12:00:00.000Z\", \"2025-06-15T12:00:00.000Z\", \"2025-06-22T12:00:00.000Z\"]"}}} playground="H4sIAL1FuGkC_4WNSwqDQBBE932KxpVCI2bA7FzlGEFCJ9PCwPyY9OT8URPX1upR9aBcyKkoWlZRFwSWkgLmIgs_H9X1r7TuUaK-0f3MG3uJlgvAQS3gmpCsTE2oXl320tBefthXme47bzlu-g1aM5iR8Ep4GTo6dcZzx5i_MxN08AX_kaBl2wAAAA">
<CodeGroup>
```python Python icon="python"
import datetime
from prefab_ui.components import Calendar
...
<ComponentPreview json={{"view":{"cssClass":"gap-6","type":"Row","children":[{"name":"calendar_5","type":"Calendar","mode":"single","value":"2026-07-04T12:00:00.000Z"},{"cssClass":"gap-2 justify-center","type":"Column","children":[{"type":"Label","text":"Selected date"},{"name":"input_1","type":"Input","inputType":"text","value":"{{ calendar_5 | date:long }}","disabled":false,"readOnly":true,"required":false}]}]},"state":{"calendar_5":"2026-07-04T12:00:00.000Z"}}} playground="H4sIAL1FuGkC_z1PywrCMBC85yuWnBoIRYpUEHLyJHhS77K22xpJk5Imav_eNtXOaWB2Hqu73vkANQYKuiPWeNdB76nB-y3qvHKTbsmGAfRyeUBDtkYv4eBM7KyEo-1jkHDCOxkJZ_dm7K3DY2ZZi70qxZ7BhAoNqNWfvdBEUv_ifCZZsSlKCTsJWyGSJwUtRSmrkPCMQ9DNqHg1zSLPf-kz0oSMX8hQFahOX3Gxymnor3cak_vP0sqNsy0XEjxhfXPWjOrqIwn2BYBNz9EdAQAA">
<CodeGroup>
```python Python icon="python"
import datetime
