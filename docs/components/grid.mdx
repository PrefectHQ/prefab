...
<ComponentPreview json={{"view":{"cssClass":"gap-4 grid-cols-3","type":"Grid","children":[{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"}]}}} playground="H4sIAAAAAAAC_y2MzQrDIBCE7z7FkpNCLCn9ORS8FfoYwegmEeIqq7av3xAyp28-hpk5RciMs53GFi4uxZwIqRYIO3EFKWDPO3z7Az4cfC-UEL9Q16NJl7YWqZhbD4vN5q5ex3JODCMEAra0oHye-nyTrpTRbbYU002LxohsN68fwwCcGnn0OnpY9XXolPgDzbnpNaUAAAA">
<CodeGroup>
...
<Tabs>
<Tab title="columns=2">
<ComponentPreview json={{"view":{"cssClass":"gap-4 grid-cols-2 p-3 border-3 border-dashed","type":"Grid","children":[{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"}]}}} playground="H4sIAAAAAAAC_02NywqDMBBF9_mKwZWCKfa5KLgr9DMkZkYNmEyY0fb3a0uhPavDXZw7CEfIQoPruzXsPMfMidKiEDaTBW7hUcNdAhrzDMv00dLzvMak7aGG0eX2VINX7fzsVNsi2yP0LEjyE3Q6ERbV1cDGwAIdhATi0kjl5Tu_2e7Kv1Y_WookbkZ7bhoQXhMS2ogw2X1TVOYFcFXjKcAAAAA">
<CodeGroup>
...
<Tab title="columns=3">
<ComponentPreview json={{"view":{"cssClass":"gap-4 grid-cols-3 p-3 border-3 border-dashed","type":"Grid","children":[{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"}]}}} playground="H4sIAAAAAAAC_02NQQqDMBBF9znF4ErBFIttFwV3hR5DYmbUgMmEGW2vX1sK7Vs9_uL9UThCFhrd0G_h4DlmTpRWhbCbrHALjxruEtCYZ1jnj5aely0m7doaJpe7Uw1etfeLU-2KbFsYWJDkJ-h0Jiyqq4GdkQV6CAnEpYnKy3d-s9-Vf61hshRJ3IL23DQgvCUktBFhtsemqMwLLAVfEMAAAAA">
<CodeGroup>
```python Python highlight={3} icon="python"
from prefab_ui.components import Div, Grid
...
<Tab title="columns=4">
<ComponentPreview json={{"view":{"cssClass":"gap-4 grid-cols-4 p-3 border-3 border-dashed","type":"Grid","children":[{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"}]}}} playground="H4sIAAAAAAAC_02NzQqDMBCE73mKxZOCKZb-HAreCn0MidlVAyYbdrV9_WoptN9lPuYwMwhHyEKD67s1HDzHzInSohA2kwXu4VnDQwIa8wrL9NHS87zGpO25htHlPbxq52en2hbZnqBnQZKfoNOJsKhuBjYGFuggJBCXRiqv33pnuyv_tvrRUiRxM9pL04DwmpDQRoTJHpuiMm-4tGq8wAAAAA">
<CodeGroup>
```python Python highlight={3} icon="python"
from prefab_ui.components import Div, Grid
...
<ComponentPreview resizable json={{"view":{"cssClass":"gap-4","type":"Grid","minColumnWidth":"10rem","children":[{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"}]}}} playground="H4sIAAAAAAAC_y2MQQqDMBAA73nFkpOCKRHaHgreCn1GiMmqC24im1i_X1s6p2EOM0lm2AQnP7qdLiHzlhOmWoBOkwpPenfwEopKHVSXnzZMyYW87pzcQbEug-6tIOsOZr8N1_ah4GTKAg4ogfg0Y3P_5y_ntQmluLD6UgY9zgYZxa_R3KwFyXuKGA1HWExvdas-rfemIacAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Div, Grid
...
<ComponentPreview json={{"view":{"cssClass":"gap-6 grid-cols-2 p-3 border-3 border-dashed","type":"Grid","children":[{"cssClass":"p-3 border-3 border-dashed","type":"Column","children":[{"content":"Left Panel","type":"H3"},{"content":"Primary content goes here.","type":"P"}]},{"cssClass":"p-3 border-3 border-dashed","type":"Column","children":[{"content":"Right Panel","type":"H3"},{"content":"Secondary content goes here.","type":"P"}]}]}}} playground="H4sIAAAAAAAC_6WPsQrCMBCG9z7FkSmF2MGCg9DJQQeHog9Q0uTaBtqkXFLEt7ckoosO4i33w3_3f3cduQlmwk62zWIK5abZWbTBg1kVBeAZrHVw4zJZEfWRjE7qVKZeiyzPspsJQzS5itO-2gro5VztBCjvGzVK7ys2b0poHWmkt9DSD6hZvo9xMSgR-U-L6SbOztgFqKXFkeUvo-asJjNJuoNyNqw_Qu_Qw4CExXPub_LF9MNH9BVXqP4KfwBMb-fMhwEAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Column,
