...
<ComponentPreview auto json={`{"columns":[{"key":"name","header":"Name","sortable":true},{"key":"status","header":"Status","sortable":false},{"key":"updated","header":"Updated","sortable":true}],"rows":[{"name":"Auth service","status":"Healthy","updated":"2 min ago"},{"name":"API gateway","status":"Degraded","updated":"30 sec ago"},{"name":"Database","status":"Healthy","updated":"5 min ago"}],"searchable":true,"paginated":true,"pageSize":10,"type":"DataTable"}`} />
...
<ComponentPreview auto json={`{"key":"users","type":"ForEach","children":[{"type":"Card","children":[{"type":"CardHeader","children":[{"cssClass":"items-center","gap":2,"type":"Row","children":[{"content":"{{ name }}","type":"CardTitle"},{"label":"{{ role }}","variant":"secondary","type":"Badge"}]},{"content":"{{ email }}","type":"CardDescription"}]}]}]}`} />
...
<ComponentPreview auto json={`{"defaultValue":"active","type":"Tabs","children":[{"title":"Active","value":"active","disabled":false,"type":"Tab","children":[{"content":"Active items go here","type":"Text"}]},{"title":"Archived","value":"archived","disabled":false,"type":"Tab","children":[{"content":"Archived items go here","type":"Text"}]}]}`} />
...
<ComponentPreview auto json={`{"accordionType":"single","collapsible":true,"type":"Accordion","children":[{"title":"Section 1","value":"s1","type":"AccordionItem","children":[{"content":"Content for section 1","type":"Text"}]},{"title":"Section 2","value":"s2","type":"AccordionItem","children":[{"content":"Content for section 2","type":"Text"}]}]}`} />
...
<ComponentPreview auto json={`{"gap":4,"type":"Column","children":[{"defaultValue":"setup","name":"step","type":"Pages","children":[{"title":"Setup","value":"setup","type":"Page","children":[{"content":"Configure your settings","type":"Text"},{"label":"Next","variant":"default","size":"default","disabled":false,"onClick":{"action":"setState","key":"step","value":"review"},"type":"Button"}]},{"title":"Review","value":"review","type":"Page","children":[{"content":"Review your choices","type":"Text"},{"label":"Next","variant":"default","size":"default","disabled":false,"onClick":{"action":"setState","key":"step","value":"complete"},"type":"Button"}]},{"title":"Complete","value":"complete","type":"Page","children":[{"content":"All done!","type":"Text"}]}]}]}`} />
...
<ComponentPreview auto json={`{"gap":2,"type":"Column","children":[{"content":"Processing: {{ progress }}%","type":"Text"},{"value":"{{ progress }}","max":100,"type":"Progress"}]}`} />
