...
<ComponentPreview height="400px" json={{"view":{"name":"deadline","type":"DatePicker","placeholder":"Select deadline"}}}>
<CodeGroup>
...
{
  "view": {"name": "deadline", "type": "DatePicker", "placeholder": "Select deadline"}
}
```
</CodeGroup>
</ComponentPreview>
...
<ComponentPreview height="400px" json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"cssClass":"gap-4 items-center","type":"Row","children":[{"name":"deadline","type":"DatePicker","placeholder":"Select deadline"},{"content":"{{ deadline | date:long }}","bold":true,"type":"Text"}]}]},"state":{"deadline":"2025-06-15T12:00:00.000Z"}}}>
<CodeGroup>
```python Python icon="python"
    ...
    "children": [
      {
        ...
        "type": "Row",
        "children": [
          {"name": "deadline", "type": "DatePicker", "placeholder": "Select deadline"},
          {"content": "{{ deadline | date:long }}", "bold": true, "type": "Text"}
        ]
      }
    ]
  },
  "state": {"deadline": "2025-06-15T12:00:00.000Z"}
}
```
</CodeGroup>
</ComponentPreview>
...
<ComponentPreview json={{"view":{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardTitle","content":"New Event"}]},{"type":"CardContent","children":[{"cssClass":"gap-3","type":"Column","children":[{"type":"Label","text":"Event Name"},{"name":"eventName","type":"Input","inputType":"text","placeholder":"Team standup","disabled":false,"readOnly":false,"required":false},{"type":"Label","text":"Date"},{"name":"eventDate","type":"DatePicker","placeholder":"Pick a date"}]}]},{"type":"CardFooter","children":[{"type":"Button","label":"Create Event","variant":"default","size":"default","disabled":false}]}]}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Button,
        ...
        "children": [
          {
            ...
            "children": [
              ...
              {"name": "eventDate", "type": "DatePicker", "placeholder": "Pick a date"}
            ]
          }
        ]
      },
