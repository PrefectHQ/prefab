...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"type":"Slider","min":0.0,"max":100.0,"name":"volume","disabled":false},{"content":"Volume: {{ volume }}%","type":"Text"},{"type":"Progress","value":"{{ volume }}","max":100}]},"state":{"volume":50}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import set_initial_state
from prefab_ui.components import Column, Progress, Slider, Text

set_initial_state(volume=50)
...
```json Protocol icon="brackets-curly"
{
  "view": {
    ...
    "children": [
      ...
      {"content": "Volume: {{ volume }}%", "type": "Text"},
      {"type": "Progress", "value": "{{ volume }}", "max": 100}
    ]
  },
  "state": {"volume": 50}
}
