...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"cssClass":"items-center gap-4","type":"Row","children":[{"name":"rating","value":3.0,"type":"Slider","min":0.0,"max":5.0,"step":0.5,"disabled":false,"size":"default"},{"cssClass":"font-bold","content":"{{ rating | stars }}","type":"Text"}]}]},"state":{"rating":3.0}}} playground="-PSAwLjUgPyAxIDogMDsKICAgICAgICAgICAgY29uc3QgZW1wdHkgPSA1IC0gZnVsbCAtIGhhbGY7CiAgICAgICAgICAgIHJldHVybiAn4piFJy5yZXBlYXQoZnVsbCkgKyAoaGFsZiA_ICfCvScgOiAnJykgKyAn4piGJy5yZXBlYXQoZW1wdHkpOwogICAgICAgIH0iIiIsCiAgICB9LAopCg">
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"cssClass":"items-center gap-4","type":"Row","children":[{"name":"temp","value":72.0,"type":"Slider","min":32.0,"max":120.0,"step":1.0,"disabled":false,"size":"default"},{"cssClass":"font-bold","content":"{{ temp | tempColor }}","type":"Text"}]}]},"state":{"temp":72.0}}} playground="-UpSc7CiAgICAgICAgICAgIGlmIChmID49IDgwKSByZXR1cm4gZiArICfCsEYg4piA77iPJzsKICAgICAgICAgICAgaWYgKGYgPj0gNjApIHJldHVybiBmICsgJ8KwRiDwn4yk77iPJzsKICAgICAgICAgICAgcmV0dXJuIGYgKyAnwrBGIOKdhO-4jyc7CiAgICAgICAgfSIiIiwKICAgIH0sCikK">
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import PrefabApp
from prefab_ui.components import Column, Row, Slider, Text
...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"name":"full_name","value":"Arthur Dent","type":"Input","inputType":"text","placeholder":"Type a name...","disabled":false,"readOnly":false,"required":false},{"cssClass":"items-center gap-2","type":"Row","children":[{"content":"Initials:","type":"Text"},{"cssClass":"font-bold","content":"{{ full_name | initials }}","type":"Text"}]}]},"state":{"full_name":"Arthur Dent"}}} playground="">
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import PrefabApp
