...
<ComponentPreview json={{"view":{"type":"DataTable","columns":[{"key":"id","header":"ID","sortable":false},{"key":"task","header":"Task","sortable":true},{"key":"status","header":"Status","sortable":false}],"rows":[{"id":"T-001","task":"Design system","status":"Complete"},{"id":"T-002","task":"API integration","status":"In Progress"},{"id":"T-003","task":"Testing","status":"Pending"},{"id":"T-004","task":"Documentation","status":"In Progress"},{"id":"T-005","task":"Deployment","status":"Pending"}],"searchable":false,"paginated":true,"pageSize":3,"caption":"Sprint tasks"}}} playground="H4sIAL5IuGkC_52RwU7DMAyG732KKKdNKmgwuCD1gNZLb5XoDaHJa70SrU2i2BUqiHcnWavRIjYkckn8O_7yx9470wrrcA-7baeuS9Nao1EzCeVPjkUKDAXsGoy_jxvTdK2OopOwiIRf5VGm5PkYhfWjYnHAPpGqkrF4RajQJTJL5TK-fJ-BDpOKYgjJmws3k8J1-BeCGLijCeRpEMa6l2Fz5m1q_iM4fRCyuFqtbnztYMQLKZKqtaCeGNuQGPE-tfH9a5BRfsa_cm6nnMc8E0oz1g5YGT0nZVrkztQOic7B1lNYgcRK13NIjroK4hnA3exXpuxaP_n_ebmfN8g2pg-wi3bGtluolQbG6jjKk4ZbUu-YrAehBBt8-clZ53smwlN-oNEy-gJW5UJAwgIAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DataTable, DataTableColumn
