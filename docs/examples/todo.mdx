...
with Row(gap=4, align="start", css_class="flex-wrap"):
    ...
    with Card(
        css_class=(
            "w-56 border-dashed flex items-center"
...
```json Protocol icon="brackets-curly"
{
  "view": {
    ...
    "children": [
      ...
      {
        "cssClass": "w-56 border-dashed flex items-center justify-center min-h-[200px]",
        "type": "Card",
        "children": [
          {
