...
<ComponentPreview auto json={`{"mode":"single","name":"selectedDate","type":"Calendar"}`} />
...
<ComponentPreview auto json={`{"_tree":{"mode":"range","name":"dateRange","type":"Calendar"},"_state":{"dateRange":"{\\"from\\": \\"2025-06-10T12:00:00.000Z\\", \\"to\\": \\"2025-06-20T12:00:00.000Z\\"}"}}`} />
...
<ComponentPreview auto json={`{"_tree":{"mode":"multiple","name":"selectedDates","type":"Calendar"},"_state":{"selectedDates":"[\\"2025-06-10T12:00:00.000Z\\", \\"2025-06-15T12:00:00.000Z\\", \\"2025-06-22T12:00:00.000Z\\"]"}}`} />

```python Calendar Multiple
import json
from prefab_ui.components import Calendar
...
<ComponentPreview auto json={`{"_tree":{"gap":6,"type":"Row","children":[{"mode":"single","name":"selectedDate","type":"Calendar"},{"gap":2,"type":"Column","children":[{"content":"Selected date:","type":"Text"},{"content":"{{ selectedDate | date:long }}","bold":true,"type":"Text"},{"content":"Raw: {{ selectedDate }}","type":"Muted"}]}]},"_state":{"selectedDate":"2025-06-15T12:00:00.000Z"}}`} />

```python Calendar with Label
