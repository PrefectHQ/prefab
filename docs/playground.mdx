...
export const PlaygroundFrame = () => {
  ...
  React.useEffect(function () {
    ...
    var url = isLocal
      ? "/playground.html"
      : "https://cdn.jsdelivr.net/npm/@prefecthq/prefab-ui-playground@latest/playground.html";
...
See the [themes docs](/styling/themes) for `Basic`, `Minimal`, `Presentation`, and custom themes.
