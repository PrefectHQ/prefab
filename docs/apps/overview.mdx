...
<ComponentPreview auto json={`{"type":"Column","gap":3,"children":[{"type":"Input","inputType":"text","placeholder":"Enter a city...","name":"city","disabled":false,"required":false},{"type":"Button","label":"Get Weather","variant":"default","size":"default","disabled":false,"onClick":{"action":"toolCall","tool":"get_weather","arguments":{"location":"{{ city }}"}}}]}`}>
<CodeGroup>
```python Python
...
<ComponentPreview auto json={`{"type":"Card","children":[{"type":"CardContent","children":[{"type":"Column","gap":3,"children":[{"type":"Input","inputType":"text","placeholder":"you@example.com","name":"email","disabled":false,"required":false},{"type":"Button","label":"Subscribe","variant":"default","size":"default","disabled":false}]}]}]}`}>
<CodeGroup>
```python Python
