...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Column","children":[{"type":"Field","invalid":false,"disabled":false,"children":[{"type":"Label","text":"Username"},{"name":"username","type":"Input","inputType":"text","placeholder":"Choose a username","disabled":false,"readOnly":false,"required":false}]},{"type":"Field","invalid":false,"disabled":false,"children":[{"type":"Label","text":"Email"},{"name":"email","type":"Input","inputType":"text","placeholder":"you@example.com","disabled":false,"readOnly":false,"required":false}]}]}}} playground="H4sIABtduGkC_4WQQQvCMAyF7_sVoacOiidPwkAYCsKuniXbMldom9K1qP_erUwFQXyn8F6-PMgQ2IIPNGB7SXrTsfXsyMUJ9DyFCDWbZJ2CoybTKzg5n6KCBlsyRXHTcVw35BV9tS13BczKfibk6izKkBTniYJDS6J8J_mqXMxKpFeswBvsaGTTU6hEPTJPBAjpw_8vO1jU5kcT5eyr5sFpT3e03tDyjRl9AsA7sSgjAQAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"type":"Field","invalid":"{{ !agree }}","disabled":false,"children":[{"type":"Label","text":"Terms and conditions"},{"name":"agree","type":"Checkbox","label":"I accept the terms of service","checked":false,"disabled":false,"required":false},{"type":"FieldError","content":"You must accept the terms to continue."}]}}} playground="H4sIABtduGkC_2WOwQrCQAxE7_2KuKctFD9A6EkUBE_FiyfZblMb7G5KNtV-vrUqHsxlBpI3k1Y4wCDYuvoy0tpzGDhi1AQ0O1HYduhvNU8F7An75iM7EZYCjq7GvoBqyrIHaffeWYp311NTVpM1K3cVRJPnmwzmWQBrTighgYsNeI4NKXFMJl8uvn02uoCleeMF9C-wNAdw3uOgoB2CLincQkK5k8dPwu9Ba848QhiT_mPKr26lOOJ6Bp9swG_HCAEAAA">
<CodeGroup>
```python Python icon="python"
