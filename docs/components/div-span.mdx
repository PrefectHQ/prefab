...
<ComponentPreview json={{"view":{"cssClass":"flex items-center gap-3 rounded-lg border p-4","type":"Div","children":[{"cssClass":"bg-emerald-500 rounded-md h-8 w-8","type":"Div"},{"content":"Custom layout with Div","type":"P"}]}}} playground="H4sIAAAAAAACE02OTQrCMBCF9znFkFULHSmoUARXegBvUNJk2gaSJuTH6u2NSsVZPd5jPr4xOAs-0CiGPuuddNa7hZYUQZcUElQMyl31vfmEW8Nqxlad5ndXyRh7aUSMZz4aeoBOZCPKAqAAk_C4h-DyokihmWBwQZXe44HXp437zxgmJEtBGIXHtv29WgUzdrBix-uvRcUvOaaibsTT5QSbUNlfLEwzS9IAAAA">
<CodeGroup>
