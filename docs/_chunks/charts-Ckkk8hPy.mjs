...
var mA = ["viewBox", "children"], gA = [
  ...
  if (!t || typeof t == "function" || typeof t == "boolean")
    return null;
  var n = t;
  if (/* @__PURE__ */ R.isValidElement(t) && (n = t.props), !wn(n))
    return null;
  var i = {};
...
var Vd = function(t) {
  ...
  if (!t || typeof t == "function" || typeof t == "boolean")
    return null;
  var i = t;
  if (/* @__PURE__ */ R.isValidElement(t) && (i = t.props), !wn(i))
    return null;
  var a = {};
    ...
    if (f && f.length) {
      var j = {
        ...
        var k = Js({
          ...
          paddingBottom: 4,
          color: C.color || "#000"
        }, u), D = C.formatter || l || bS, q = C.value, B = C.name, U = q, X = B;
        if (D && U != null && X != null) {
          var z = D(q, B, C, M, f);
          if (Array.isArray(z)) {
            var Z = fS(z, 2);
...
var uj = /* @__PURE__ */ R.forwardRef(function(e, t) {
  var r = e.aspect, n = e.initialDimension, i = n === void 0 ? {
    width: -1,
    height: -1
  } : n, a = e.width, o = a === void 0 ? "100%" : a, u = e.height, c = u === void 0 ? "100%" : u, s = e.minWidth, f = s === void 0 ? 0 : s, l = e.minHeight, p = e.maxHeight, d = e.children, y = e.debounce, v = y === void 0 ? 0 : y, h = e.id, g = e.className, b = e.onResize, O = e.style, w = O === void 0 ? {} : O, m = R.useRef(null), x = R.useRef();
  ...
  }), P = rj(_, 2), S = P[0], T = P[1], E = R.useCallback(function($, C) {
    T(function(M) {
      var k = Math.round($), D = Math.round(C);
      return M.containerWidth === k && M.containerHeight === D ? M : {
        containerWidth: k,
        containerHeight: D
      };
    });
  ...
  R.useEffect(function() {
    ...
    var C = new ResizeObserver($), M = m.current.getBoundingClientRect(), k = M.width, D = M.height;
    return E(k, D), C.observe(m.current), function() {
      C.disconnect();
    };
  }, [E, v]);
  var j = R.useMemo(function() {
    ...
    var D = !Array.isArray(d) && jt(d.type).endsWith("Chart");
    return A.Children.map(d, function(q) {
      return /* @__PURE__ */ A.isValidElement(q) ? /* @__PURE__ */ R.cloneElement(q, Ji({
        width: M,
        height: k
      }, D ? {
        style: Ji({
...
var Xx = /[ \f\n\r\t\v\u2028\u2029]+/, Yx = function(t) {
  ...
  var o = t.maxLines, u = t.children, c = t.style, s = t.breakAll, f = L(o), l = u, p = function() {
    ...
    return M.reduce(function(k, D) {
      var q = D.word, B = D.width, U = k[k.length - 1];
  ...
  for (var v = "…", h = function(M) {
    var k = l.slice(0, M), D = Yx({
      breakAll: s,
      style: c,
      children: k + v
    }).wordsWithComputedWidth, q = p(D), B = q.length > o || y(q).width > Number(i);
    return [B, q];
  ...
  var r = t.x, n = r === void 0 ? 0 : r, i = t.y, a = i === void 0 ? 0 : i, o = t.lineHeight, u = o === void 0 ? "1em" : o, c = t.capHeight, s = c === void 0 ? "0.71em" : c, f = t.scaleToFit, l = f === void 0 ? !1 : f, p = t.textAnchor, d = p === void 0 ? "start" : p, y = t.verticalAnchor, v = y === void 0 ? "end" : y, h = t.fill, g = h === void 0 ? Tm : h, b = Pm(t, $j), O = R.useMemo(function() {
    return Lj({
      breakAll: b.breakAll,
      children: b.children,
      maxLines: b.maxLines,
      ...
      if (x === "c")
        ...
        if (j = isNaN(j) ? c : S(Math.abs(j), w), m && (j = ME(j)), q && +j == 0 && v !== "+" && (q = !1), $ = (q ? v === "(" ? v : u : v === "-" || v === "(" ? "" : v) + $, C = (x === "s" && !isNaN(j) && Ea !== void 0 ? Vm[8 + Ea / 3] : "") + C + (q && v === "(" ? ")" : ""), T) {
          for (M = -1, k = j.length; ++M < k; )
            if (D = j.charCodeAt(M), 48 > D || D > 57) {
              C = (D === 46 ? i + j.slice(M + 1) : j.slice(M)) + C, j = j.slice(0, M);
              break;
            }
        }
      }
    ...
    value: function() {
      ...
      var y = c.map(function(v) {
        ...
        if (a === "vertical") {
          ...
          var M = l.scale, k = g + i, D = k - o, q = k + o, B = M(O - x), U = M(O + _);
          m.push({
            x1: D,
            y1: U,
            x2: q,
...
function $e(e) {
  ...
  if (!a || J(u) && J(c) && !/* @__PURE__ */ R.isValidElement(s) && !G(s))
    return null;
  if (/* @__PURE__ */ R.isValidElement(s))
    return /* @__PURE__ */ R.cloneElement(s, i);
  var d;
  if (G(s)) {
    if (d = /* @__PURE__ */ R.createElement(s, i), /* @__PURE__ */ R.isValidElement(d))
      return d;
  } else
    d = iC(i);
  var y = sC(a), v = K(i, !0);
...
var Kg = {
  ...
  return /* @__PURE__ */ R.createElement("path", zf({}, K(t, !1), fa(t), {
...
var Ye = /* @__PURE__ */ (function(e) {
  ...
  return mk(r, [{
    ...
    value: function() {
      ...
      var c = sk(i, ck), s = R.Children.count(a), f = this.state.style;
      if (typeof a == "function")
        return a(f);
      if (!u || s === 0 || o <= 0)
        return a;
      var l = function(d) {
        var y = d.props, v = y.style, h = v === void 0 ? {} : v, g = y.className, b = /* @__PURE__ */ R.cloneElement(d, at(at({}, c), {}, {
          style: at(at({}, h), f),
          className: g
        }));
        return b;
      };
      return s === 1 ? l(R.Children.only(a)) : /* @__PURE__ */ A.createElement("div", null, R.Children.map(a, function(p) {
        return l(p);
      }));
    }
  }]), r;
...
var hb = function(t, r, n, i, a) {
  ...
  var r = pb(pb({}, Mk), t), n = R.useRef(), i = R.useState(-1), a = wk(i, 2), o = a[0], u = a[1];
  R.useEffect(function() {
...
var En = function(t) {
  ...
  return r === +r && n === +n && i === +i ? /* @__PURE__ */ R.createElement("circle", ep({}, K(t, !1), fa(t), {
    className: o,
    cx: r,
    cy: n,
    r: i
...
var Cb = function(t, r, n, i, a) {
  ...
  var r = Mb(Mb({}, HR), t), n = R.useRef(), i = R.useState(-1), a = LR(i, 2), o = a[0], u = a[1];
  R.useEffect(function() {
    if (n.current && n.current.getTotalLength)
      try {
...
function jh(e) {
  ...
  if (/* @__PURE__ */ R.isValidElement(t))
    s = /* @__PURE__ */ R.cloneElement(t, Xa(Xa({}, c), rD(t)));
  else if (G(t))
    s = t(c);
  else if (kR(t) && !NR(t)) {
    var f = i(t, c);
...
et(qt, "getComposedData", function(e) {
  ...
  if (m > 0) {
    ...
    x = i.map(function(P, S) {
      ...
      var C = $ + Me(v) * ((T !== 0 ? d : 0) + j * w), M = ($ + C) / 2, k = (y.innerRadius + y.outerRadius) / 2, D = [{
        name: E,
        value: T,
        payload: P,
        dataKey: g,
...
mr(Hi, "getComposedData", function(e) {
  ...
  var y = a.cx, v = a.cy, h = r.layout, g = t.props, b = g.children, O = g.minPointSize, w = h === "radial" ? a : n, m = s ? w.scale.domain() : null, x = rw({
    ...
    if (s ? E = ew(s[p + T], m) : (E = ve(S, c), Array.isArray(E) || (E = [x, E])), h === "radial") {
      ...
      var D = M - C;
      if (Math.abs(O) > 0 && Math.abs(D) < Math.abs(O)) {
        var q = Me(D || O) * (Math.abs(O) - Math.abs(D));
        M += q;
      }
      k = {
        background: {
...
Kt(Tr, "getComposedData", function(e) {
  ...
  var y = t.layout, v = r.type.defaultProps, h = v !== void 0 ? xe(xe({}, v), r.props) : r.props, g = h.dataKey, b = h.children, O = h.minPointSize, w = y === "horizontal" ? o : a, m = s ? w.scale.domain() : null, x = rw({
    ...
    var D = SN(O, Rw.defaultProps.minPointSize)(E[1], T);
    if (y === "horizontal") {
      ...
      if (M = Number.isNaN(z) ? 0 : z, k = {
        ...
        var Z = Me(M || D) * (Math.abs(D) - Math.abs(M));
        $ -= Z, M += Z;
      }
    } else {
      ...
      if (j = be, $ = Na({
        ...
        var Qt = Me(C || D) * (Math.abs(D) - Math.abs(C));
        C += Qt;
      }
    }
    return xe(xe(xe({}, S), {}, {
    ...
    if (v.type === "number" && (v.padding === "gap" || v.padding === "no-gap")) {
      ...
      if (C.forEach(function(he, be) {
        ...
        if (v.padding === "gap" && (_ = M * k / 2), v.padding === "no-gap") {
          var D = Ne(t.barCategoryGap, M * k), q = M * k / 2;
          _ = q - D - (q - D) / k * D;
        }
      }
    }
...
var ZN = YN(function(e) {
...
}), $h = /* @__PURE__ */ R.createContext(void 0), Mh = /* @__PURE__ */ R.createContext(void 0), Fw = /* @__PURE__ */ R.createContext(void 0), Ww = /* @__PURE__ */ R.createContext({}), zw = /* @__PURE__ */ R.createContext(void 0), Uw = /* @__PURE__ */ R.createContext(0), Kw = /* @__PURE__ */ R.createContext(0), b0 = function(t) {
  ...
  return R.useContext(zw);
}, Hw = function(t) {
  var r = R.useContext($h);
  r == null && Or();
  var n = r[t];
  return n == null && Or(), n;
}, QN = function() {
  var t = R.useContext($h);
  return zt(t);
}, e2 = function() {
  var t = R.useContext(Mh), r = VN(t, function(n) {
    return kw(n.domain, Number.isFinite);
  });
  return r || zt(t);
}, Gw = function(t) {
  var r = R.useContext(Mh);
  r == null && Or();
  var n = r[t];
  return n == null && Or(), n;
}, t2 = function() {
  var t = R.useContext(Fw);
  return t;
}, r2 = function() {
  return R.useContext(Ww);
}, Ch = function() {
  return R.useContext(Kw);
}, Ih = function() {
  return R.useContext(Uw);
};
function fn(e) {
  "@babel/helpers - typeof";
      ...
      return /* @__PURE__ */ A.createElement(Ye, {
        ...
        if (b) {
          var x = b.length / u.length, _ = u.map(function(j, $) {
            var C = Math.floor($ * x);
            if (b[C]) {
              var M = b[C], k = pe(M.x, j.x), D = pe(M.y, j.y);
              return Ke(Ke({}, j), {}, {
                x: k(m),
                y: D(m)
              });
...
function VL(e) {
  ...
  return i == null ? null : (
    ...
    /* @__PURE__ */ R.createElement($n, wp({}, i, {
...
var Rt = /* @__PURE__ */ (function(e) {
  ...
  return HL(t, e), WL(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ R.createElement(VL, this.props);
    }
  }]);
})(R.Component);
...
var nq = function(t) {
  ...
  return a == null ? null : (
    // @ts-expect-error the axisOptions type is not exactly what CartesianAxis is expecting.
    /* @__PURE__ */ R.createElement($n, Ap({}, a, {
  ...
  return tq(t, e), ZL(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ R.createElement(nq, this.props);
    }
  }]);
})(R.Component);
...
function wq(e) {
  ...
  return /* @__PURE__ */ R.isValidElement(d) ? /* @__PURE__ */ R.cloneElement(d, x) : /* @__PURE__ */ R.createElement(v, x);
}
...
var Tp = function(t, r, n, i) {
  ...
  return n.reduce(function(y, v) {
    ...
    var M = w_(b);
    if (!j || j.length === 0) {
      var k, D = (k = g.domain) !== null && k !== void 0 ? k : M;
      if (O) {
        if (j = Xn(T, O, b), b === "category" && d) {
          var q = vA(j);
          m && q ? ($ = j, j = to(0, E)) : m || (j = Cg(D, j, v).reduce(function(z, Z) {
            return z.indexOf(Z) >= 0 ? z : [].concat(xn(z), [Z]);
          }, []));
        } else if (b === "category")
          m ? j = j.filter(function(z) {
            return z !== "" && !J(z);
          }) : j = Cg(D, j, v).reduce(function(z, Z) {
      ...
      if (b === "number")
        j = Sp(l, j, S, a, _), D && (j = qf(D, j, w));
      else if (b === "category" && D) {
        var U = D, X = j.every(function(z) {
  ...
  var r = t.chartName, n = t.GraphicalChild, i = t.defaultTooltipEventType, a = i === void 0 ? "axis" : i, o = t.validateTooltipEventTypes, u = o === void 0 ? ["axis"] : o, c = t.axisComponents, s = t.legendContent, f = t.formatAxisMap, l = t.defaultProps, p = function(g, b) {
    var O = b.graphicalItems, w = b.stackGroups, m = b.offset, x = b.updateId, _ = b.dataStartIndex, P = b.dataEndIndex, S = g.barSize, T = g.layout, E = g.barGap, j = g.barCategoryGap, $ = g.maxBarSize, C = K0(T), M = C.numericAxisName, k = C.cateAxisName, D = Vq(O), q = [];
    return O.forEach(function(B, U) {
      ...
      }, Qt), W = qe[k], ee = qe["".concat(k, "Ticks")], te = w && w[be] && w[be].hasStack && IM(B, w[be].stackGroups), N = jt(B.type).indexOf("Bar") >= 0, me = La(W, ee), re = [], we = D && _M({
        barSize: S,
        stackGroups: w,
        totalSize: Yq(qe, k)
      });
    ...
    if (!Vd({
      ...
      return null;
    var _ = O.children, P = O.layout, S = O.stackOffset, T = O.data, E = O.reverseStackOrder, j = K0(P), $ = j.numericAxisName, C = j.cateAxisName, M = We(_, n), k = CM(T, M, "".concat($, "Id"), "".concat(C, "Id"), S, E), D = c.reduce(function(z, Z) {
    ...
    Object.keys(D).forEach(function(z) {
      D[z] = f(O, D[z], q, z.replace("Map", ""), r);
    });
    var B = D["".concat(C, "Map")], U = Gq(B), X = p(O, I(I({}, D), {}, {
      dataStartIndex: w,
      dataEndIndex: m,
      updateId: x,
      graphicalItems: M,
    ...
    function g(b) {
      ...
      return Tq(this, g), m = Cq(this, g, [b]), V(m, "eventEmitterSymbol", Symbol("rechartsEventEmitter")), V(m, "accessibilityManager", new vq()), V(m, "handleLegendBBoxUpdate", function(x) {
        ...
        if (x.dataStartIndex !== void 0 || x.dataEndIndex !== void 0)
          ...
          var $ = x.chartX, C = x.chartY, M = x.activeTooltipIndex, k = m.state, D = k.offset, q = k.tooltipTicks;
          if (!D)
            return;
        ...
        var _, P = m.state, S = P.isTooltipActive, T = P.activeCoordinate, E = P.activePayload, j = P.offset, $ = P.activeTooltipIndex, C = P.tooltipAxisBandSize, M = m.getTooltipEventType(), k = (_ = x.props.active) !== null && _ !== void 0 ? _ : S, D = m.props.layout, q = x.key || "_recharts-cursor";
        ...
        return /* @__PURE__ */ R.cloneElement(x, I(I({}, $), {}, {
          className: Y(S, $.className),
          key: x.key || "".concat(_, "-").concat(P),
          ticks: St($, !0)
        }));
      }), V(m, "renderPolarGrid", function(x) {
        var _ = x.props, P = _.radialLines, S = _.polarAngles, T = _.polarRadius, E = m.state, j = E.radiusAxisMap, $ = E.angleAxisMap, C = zt(j), M = zt($), k = M.cx, D = M.cy, q = M.innerRadius, B = M.outerRadius;
        ...
        if (!$)
          return null;
        var C = $.item, M = F0($, _q);
        return /* @__PURE__ */ R.cloneElement(C, I(I({}, M), {}, {
          chartWidth: S,
          chartHeight: T,
          margin: E,
        ...
        if (!T)
          return null;
        var E = m.state, j = E.isTooltipActive, $ = E.activeCoordinate, C = E.activePayload, M = E.activeLabel, k = E.offset, D = (x = T.props.active) !== null && x !== void 0 ? x : j;
        ...
        if (!x)
          return null;
        var S = m, T = S.clipPathId, E = m.state, j = E.xAxisMap, $ = E.yAxisMap, C = E.offset, M = x.type.defaultProps || {}, k = x.props, D = k.xAxisId, q = D === void 0 ? M.xAxisId : D, B = k.yAxisId, U = B === void 0 ? M.yAxisId : B;
        return /* @__PURE__ */ R.cloneElement(x, {
          key: x.key || "".concat(_, "-").concat(P),
          xAxis: j[q],
          yAxis: $[U],
        ...
        var _ = x.item, P = x.activePoint, S = x.basePoint, T = x.childIndex, E = x.isRange, j = [], $ = _.props.key, C = _.item.type.defaultProps !== void 0 ? I(I({}, _.item.type.defaultProps), _.item.props) : _.item.props, M = C.activeDot, k = C.dataKey, D = I(I({
          index: T,
          dataKey: k,
          cx: P.x,
          cy: P.y,
        ...
        return j.push(g.renderActiveDot(M, D, "".concat($, "-activePoint-").concat(T))), S ? j.push(g.renderActiveDot(M, I(I({}, D), {}, {
          cx: S.x,
          cy: S.y
        ...
        if (!S)
          return null;
        var T = m.getTooltipEventType(), E = m.state, j = E.isTooltipActive, $ = E.tooltipAxis, C = E.activeTooltipIndex, M = E.activeLabel, k = m.props.children, D = Ge(k, ft), q = S.props, B = q.points, U = q.isRange, X = q.baseLine, z = S.item.type.defaultProps !== void 0 ? I(I({}, S.item.type.defaultProps), S.item.props) : S.item.props, Z = z.activeDot, he = z.hide, be = z.activeBar, Ue = z.activeShape, Qt = !!(!he && j && D && (Z || be || Ue)), qe = {};
        T !== "axis" && D && D.props.trigger === "click" ? qe = {
        ...
        var W = /* @__PURE__ */ R.cloneElement(x, I(I({}, S.props), qe));
        function ee(tr) {
        ...
        if (Qt)
          if (C >= 0) {
            ...
            if (Ue || be) {
              ...
              return [/* @__PURE__ */ R.cloneElement(x, I(I(I({}, S.props), qe), {}, {
                activeIndex: re
              })), null, null];
            }
            if (!J(te))
            ...
            return [/* @__PURE__ */ R.cloneElement(Ir, er), null, null];
          }
    ...
    return Rq(g, h), Mq(g, [{
      ...
      value: function() {
        ...
        if (P) {
          ...
          if (!(typeof S != "number" || S < 0 || S > this.state.tooltipTicks.length - 1)) {
            ...
            this.setState(D), this.renderCursor(P), this.accessibilityManager.setIndex(S);
          }
        }
      }
    }, {
      ...
      value: function(O) {
        ...
        if ($ !== "axis" && E && j) {
          var M = zt(E).scale, k = zt(j).scale, D = M && M.invert ? M.invert(_.chartX) : null, q = k && k.invert ? k.invert(_.chartY) : null;
          return I(I({}, _), {}, {
            xValue: D,
            yValue: q
          }, C);
          ...
          for (var _ = 0, P = m.length; _ < P; _++) {
            ...
            if ($ === "Bar") {
              ...
              var k = sD({
                ...
                activeTooltipItem: x,
                itemData: j.data
              }), D = j.activeIndex === void 0 ? k : j.activeIndex;
              return {
                graphicalItem: I(I({}, S), {}, {
                  childIndex: D
                }),
  ...
  V(y, "displayName", r), V(y, "defaultProps", I({
    ...
    if (!uf(w, g.prevChildren)) {
      var D, q, B, U, X = Ge(w, sn), z = X && (D = (q = X.props) === null || q === void 0 ? void 0 : q.startIndex) !== null && D !== void 0 ? D : T, Z = X && (B = (U = X.props) === null || U === void 0 ? void 0 : U.endIndex) !== null && B !== void 0 ? B : E, he = z !== T || Z !== E, be = !J(O), Ue = be && !he ? g.updateId : g.updateId + 1;
      return I(I({
        updateId: Ue
      }, d(I(I({
        props: h
    ...
    var O;
    return /* @__PURE__ */ R.isValidElement(h) ? O = /* @__PURE__ */ R.cloneElement(h, g) : G(h) ? O = h(g) : O = /* @__PURE__ */ A.createElement(En, g), /* @__PURE__ */ A.createElement(Q, {
...
const nB = { light: "", dark: ".dark" }, __ = R.createContext(null);
function A_() {
  const e = R.useContext(__);
  if (!e)
    throw new Error("useChart must be used within a <ChartContainer />");
  return e;
}
const $r = R.forwardRef(({ id: e, className: t, children: r, config: n, ...i }, a) => {
  ...
  }, []), /* @__PURE__ */ F.jsx(__.Provider, { value: { config: n }, children: /* @__PURE__ */ F.jsxs(
    "div",
    {
      "data-chart": u,
      ref: a,
