...
<ComponentPreview auto json={`{"cssClass":"items-center","type":"Row","gap":3,"children":[{"type":"Button","label":"Download","icon":"download","variant":"default","size":"default","disabled":false},{"type":"Button","label":"Settings","icon":"settings","variant":"outline","size":"default","disabled":false},{"type":"Button","label":"Delete","icon":"trash-2","variant":"destructive","size":"default","disabled":false}]}`}>
<CodeGroup>
```python Python
...
<ComponentPreview auto json={`{"cssClass":"items-center","type":"Row","gap":3,"children":[{"type":"Button","label":"","icon":"plus","variant":"default","size":"icon-xs","disabled":false},{"type":"Button","label":"","icon":"plus","variant":"default","size":"icon-sm","disabled":false},{"type":"Button","label":"","icon":"plus","variant":"default","size":"icon","disabled":false},{"type":"Button","label":"","icon":"plus","variant":"default","size":"icon-lg","disabled":false}]}`}>
<CodeGroup>
```python Python
from prefab_ui.components import Button, Row
...
<ParamField body="icon" type="str | None" default="None">
  Lucide icon name in kebab-case (e.g., `"download"`, `"settings"`). Browse icons at [lucide.dev/icons](https://lucide.dev/icons).
</ParamField>
