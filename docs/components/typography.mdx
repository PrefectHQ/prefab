...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"cssClass":"gap-4","type":"Column","children":[{"content":"Dashboard","type":"H1"},{"content":"Monitor your application metrics and performance.","type":"Lead"},{"content":"Everything you need to manage your MCP server, organized in one place.","type":"P"},{"content":"Last updated 5 minutes ago","type":"Muted"}]}}`}>
<CodeGroup>
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"cssClass":"gap-4","type":"Column","children":[{"content":"H1 \\u2014 Page Title","type":"H1"},{"content":"H2 \\u2014 Section Heading","type":"H2"},{"content":"H3 \\u2014 Subsection","type":"H3"},{"content":"H4 \\u2014 Detail Heading","type":"H4"}]}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    H1,
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"cssClass":"gap-3","type":"Column","children":[{"content":"Terms and conditions apply","type":"Small"},{"content":"Last updated 5 minutes ago","type":"Muted"}]}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Small,
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"content":"The best way to predict the future is to invent it.","type":"BlockQuote"}}`}>
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"cssClass":"gap-2 items-center","type":"Row","children":[{"content":"Run","type":"P"},{"content":"pip install prefab-ui","type":"InlineCode"},{"content":"to get started.","type":"P"}]}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    InlineCode,
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"cssClass":"gap-2","type":"Column","children":[{"content":"Regular paragraph text.","type":"P"},{"content":"This is bold.","bold":true,"type":"P"},{"content":"This is italic.","italic":true,"type":"P"},{"type":"Text","content":"Bold and italic combined.","bold":true,"italic":true}]}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    P,
...
For the complete protocol schemas, see [Text](/protocol/text), [H1](/protocol/h1), [H2](/protocol/h2), [H3](/protocol/h3), [H4](/protocol/h4), [P](/protocol/p), [Lead](/protocol/lead), [Large](/protocol/large), [Small](/protocol/small), [Muted](/protocol/muted), [BlockQuote](/protocol/block-quote), [InlineCode](/protocol/inline-code), [Heading](/protocol/heading), and [Markdown](/protocol/markdown).
