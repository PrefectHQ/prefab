...
<ComponentPreview json={{"view":{"cssClass":"gap-6 max-w-sm mx-auto","type":"Column","children":[{"content":"Health Monitor","type":"H3"},{"content":"Drag the slider \u2014 the bar color changes at each threshold.","type":"Muted"},{"cssClass":"gap-4","type":"Column","children":[{"cssClass":"justify-between items-center","type":"Row","children":[{"content":"CPU Usage","type":"Text"},{"cssClass":"font-bold","content":"{{ slider_22 / 100 | percent }}","type":"Text"}]},{"type":"Progress","value":"{{ slider_22 }}","min":0,"max":100,"variant":"default","indicatorClass":"{{ slider_22 < 20 ? 'bg-red-500' : (slider_22 < 60 ? 'bg-primary' : (slider_22 < 75 ? 'bg-amber-500' : 'bg-green-500')) }}"},{"name":"slider_22","type":"Slider","min":0.0,"max":100.0,"value":50.0,"step":1.0,"disabled":false}]}]},"state":{"slider_22":50.0}}} playground="H4sIAAAAAAACE3WSz27cIBDG736KEScs4a3TdFMpKqf0sJdIUf6cI2zP2lQGLMBd59aHyBPmSTJ22WSdtBwQw-j7zfAxe-8MDB73qnoc9aZ2ZnAWbQyg6eQjXLl-NFbA7lzA9RixEXDjXesxBAG37iDgrtcNegH3OMVsv-b56ci5nbLst-pB0on3ylSNuoSwSPMsO-jYpVK8VYO8EFCH8Fj3KgTJjJqKQxEMmKlQY3Qsv8yA1u6csx2qnrTXzuroPMuXxNIoZz-9aiF2mOrAy5_nJayUh9r1jvZO2RYDqAio6o6y9LDO9c2GSAvqY2ffUu23HHnAT3r9NYao909FhfGAaEFHNKGoyVL07EQ7r9kxzq5uHuAhqBZT86ssnz37AmdlmW8G9DOH5wIqalHe-xHfJcdf4SsIyUeUtIvVtbaNrhUZltpeyvyAr1SFDLJrxrxY1RYem2Jblkx8yib5xX_lR8TgtVH-6R-IE8z3bcLMCpoU9H_LLgR6I9olzj9DPlydhO8-pVmQaW650VaWAmjGJLksIEQc5JlIzm3LPHsF4RQYZiQDAAA">
<CodeGroup>
