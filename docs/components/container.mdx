...
<ComponentPreview auto json={`{"view":{"type":"Container","children":[{"content":"The Hitchhiker's Guide to the Galaxy","type":"H1"},{"content":"A wholly remarkable book, the standard repository for all the knowledge and wisdom in the Galaxy.","type":"P"}]}}`}>
<CodeGroup>
