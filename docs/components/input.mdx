...
<ComponentPreview json={{"view":{"type":"Input","inputType":"text","placeholder":"Enter your email...","name":"input-3","disabled":false,"required":false}}}>
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Column","children":[{"type":"Input","inputType":"email","placeholder":"Email","name":"input-4","disabled":false,"required":false},{"type":"Input","inputType":"password","placeholder":"Password","name":"input-5","disabled":false,"required":false},{"type":"Input","inputType":"number","placeholder":"Age","name":"input-6","disabled":false,"required":false},{"type":"Input","inputType":"tel","placeholder":"Phone","name":"input-7","disabled":false,"required":false}]}}}>
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Email address"},{"type":"Input","inputType":"email","placeholder":"you@example.com","name":"input-8","disabled":false,"required":true}]}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Column,
...
<ComponentPreview json={{"view":{"type":"Input","inputType":"text","placeholder":"Disabled input","name":"input-9","disabled":true,"required":false}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Input
