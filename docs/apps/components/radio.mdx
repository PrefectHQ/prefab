...
<ComponentPreview auto json={`{"name":"size","type":"RadioGroup","children":[{"value":"sm","label":"Small","checked":false,"disabled":false,"required":false,"type":"Radio"},{"value":"md","label":"Medium","checked":true,"disabled":false,"required":false,"type":"Radio"},{"value":"lg","label":"Large","checked":false,"disabled":false,"required":false,"type":"Radio"}]}`} />
...
<ComponentPreview auto json={`{"gap":3,"type":"Column","children":[{"value":"yes","label":"Yes","checked":false,"name":"answer","disabled":false,"required":false,"type":"Radio"},{"value":"no","label":"No","checked":true,"name":"answer","disabled":false,"required":false,"type":"Radio"}]}`} />
...
<ComponentPreview auto json={`{"name":"plan","type":"RadioGroup","children":[{"value":"free","label":"Free","checked":true,"disabled":false,"required":false,"type":"Radio"},{"value":"pro","label":"Pro","checked":false,"disabled":false,"required":false,"type":"Radio"},{"value":"enterprise","label":"Enterprise","checked":false,"disabled":true,"required":false,"type":"Radio"}]}`} />
