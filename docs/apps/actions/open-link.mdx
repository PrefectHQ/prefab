...
<ComponentPreview auto json={`{"gap":4,"type":"Row","children":[{"label":"GitHub","variant":"link","size":"default","disabled":false,"onClick":{"action":"openLink","url":"https://github.com/prefecthq/prefab"},"type":"Button"},{"label":"PyPI","variant":"link","size":"default","disabled":false,"onClick":{"action":"openLink","url":"https://pypi.org/project/prefab-ui"},"type":"Button"}]}`} />
