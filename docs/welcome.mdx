                                ...
                                "children": [
                                  {
                                    ...
                                    "type": "Row",
                                    "children": [
                                      {"content": "{{ ctx_tick % 19 * 3 + 24 }}% used", "type": "Text"},
                                      {
                                        "content": "{{ (ctx_tick % 19 * 3 + 24) * 2 }}k / 200k tokens",
                                        "type": "Muted"
                                      }
                                    ]
                                  },
                                  {
                                    ...
                                    "children": [
                                      {
                                        "type": "Progress",
                                        "value": "{{ ctx_tick % 19 * 3 + 24 }}",
                                        "max": 100.0,
                                        "variant": "{{ ctx_tick % 19 * 3 + 24 > 70 ? 'destructive' : (ctx_tick % 19 * 3 + 24 <= 33 ? 'success' : 'default') }}",
                                        "size": "default"
                                      }
                                    ]
                                  }
