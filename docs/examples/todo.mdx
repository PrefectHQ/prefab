                        ...
                        with If("not $item.done or show_done"):
                            with Row(gap=2, align="center"):
                                ...
                                Input(
                                    ...
                                    css_class="border-0 shadow-none p-0 h-auto focus-visible:ring-0 focus-visible:ring-offset-0",
                                )
                                ...
                                "children": [
                                  {
                                    ...
                                    "children": [
                                      ...
                                      {
                                        "cssClass": "border-0 shadow-none p-0 h-auto focus-visible:ring-0 focus-visible:ring-offset-0",
                                        "type": "Input",
                                        "inputType": "text",
                                        "name": "groups.{{ gi }}.todos.{{ $index }}.text",
                                        "disabled": false,
