...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Column","children":[{"name":"select_6","type":"Select","placeholder":"Choose a planet...","size":"default","disabled":false,"required":false,"children":[{"type":"SelectOption","value":"magrathea","label":"Magrathea","selected":false,"disabled":false},{"type":"SelectOption","value":"betelgeuse","label":"Betelgeuse V","selected":false,"disabled":false},{"type":"SelectOption","value":"vogsphere","label":"Vogsphere","selected":false,"disabled":false},{"type":"SelectOption","value":"earth","label":"Earth (Mostly Harmless)","selected":false,"disabled":false}]},{"content":"You chose: {{ select_6 }}","type":"Text"}]}}}>
<CodeGroup>
```python Python icon="python"
...
```json Protocol icon="brackets-curly"
{
  "view": {
    ...
    "children": [
      ...
      {"content": "You chose: {{ select_6 }}", "type": "Text"}
    ]
  }
}
```
