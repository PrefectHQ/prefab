...
<ComponentPreview auto json={`{"gap":3,"type":"Column","children":[{"text":"Name","type":"Label"},{"inputType":"text","placeholder":"Your name","name":"name","disabled":false,"required":false,"type":"Input"},{"text":"Email","type":"Label"},{"inputType":"email","placeholder":"you@example.com","name":"email","disabled":false,"required":false,"type":"Input"},{"label":"Submit","variant":"default","size":"default","disabled":false,"onClick":{"action":"callTool","tool":"create_user","arguments":{"name":"{{ name }}","email":"{{ email }}"}},"type":"Button"}]}`} />
...
<ComponentPreview auto json={`{"gap":4,"onSubmit":{"onError":{"action":"showToast","message":"{{ $error }}","variant":"error"},"action":"callTool","tool":"submit_contact","arguments":{"data":{"name":"{{ name }}","email":"{{ email }}","message":"{{ message }}"}}},"type":"Form","children":[{"gap":2,"type":"Column","children":[{"text":"Full Name","type":"Label"},{"inputType":"text","placeholder":"Full Name","name":"name","disabled":false,"required":true,"minLength":1,"type":"Input"}]},{"gap":2,"type":"Column","children":[{"text":"Email","type":"Label"},{"inputType":"email","placeholder":"Email","name":"email","disabled":false,"required":true,"type":"Input"}]},{"gap":2,"type":"Column","children":[{"text":"Message","type":"Label"},{"placeholder":"Your message","name":"message","rows":4,"disabled":false,"required":true,"type":"Textarea"}]},{"label":"Submit","variant":"default","size":"default","disabled":false,"onClick":{"onError":{"action":"showToast","message":"{{ $error }}","variant":"error"},"action":"callTool","tool":"submit_contact","arguments":{"data":{"name":"{{ name }}","email":"{{ email }}","message":"{{ message }}"}}},"type":"Button"}]}`} />
