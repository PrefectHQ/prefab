...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"cssClass":"gap-2","type":"Row","children":[{"type":"ForEach","key":"tags","children":[{"type":"Badge","label":"{{ _item }}","variant":"secondary"}]}]},"tags":["earth","magrathea","vogon poetry","42"]}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    ForEach,
