...
<ComponentPreview json={{"view":{"cssClass":"gap-4 items-center","type":"Row","children":[{"content":"Left","type":"Span"},{"cssClass":"h-4","type":"Separator","orientation":"vertical"},{"content":"Middle","type":"Span"},{"cssClass":"h-4","type":"Separator","orientation":"vertical"},{"content":"Right","type":"Span"}]}}} playground="">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Row,
...
```json Protocol icon="brackets-curly"
{
  "view": {
    ...
    "children": [
      ...
      {"content": "Middle", "type": "Span"},
      {"cssClass": "h-4", "type": "Separator", "orientation": "vertical"},
      {"content": "Right", "type": "Span"}
    ]
  }
}
```
