...
<ComponentPreview json={{"view":{"type":"Code","content":"def answer() -> int:\n    \"\"\"Return the Answer to the Ultimate Question\n    of Life, the Universe, and Everything.\"\"\"\n    return 42","language":"python"}}} playground="H4sIAAAAAAACEyWOQQvCMAyF7_0VoacN5g7iSVAQ8eZFwZsg1aUzsCWlTRX_vd2WQHgP3veIjzJCiOjd85GpfckYhJE1ARUVFY7SoTHTray1pkMPjtMXY1XDag_EujVQ5m6nvaLmyKBvhMOcApXZ3Qal0SnCJWNSEp4h8XAmj80SYfpgTMU57uBU9E_fxH27VM9AXPo3a1OeaZNGClXdwOC4z67HnQ2FEba1-QORhvrh2QAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"type":"Code","content":"pip install prefab-ui","language":"bash"},{"type":"Code","content":"SELECT name, designation\nFROM crew\nWHERE ship = 'Heart of Gold';","language":"sql"},{"type":"Code","content":"{ \"ship\": \"Heart of Gold\", \"drive\": \"Infinite Improbability\" }","language":"json"}]}}} playground="H4sIAAAAAAACE1VPTUvDQBC951cMc0kL0Yu3Sk4ltYUWoQpeBJk0m2Rkd3bd3VhE_O9uJJh2DsN8vHnzXuutAedVS_XbwLcna5wVJTEAp8pHWNtGFSnrwUiWnTn2U7PoyJV3y1UGKUbUAh07YAmRtJ44bwbGAjRJN1CnSqwp9LicT_6qMfCp2lfrZxAy6V2jAndCka28Cs6gzfHxACevzlfTl211rCD06XsJ-VZRkm1beLC6ye-x-AfOMsKHnuYXWvJvwJEEV4BXJMkBNp4_1bjZScvCUcHOOG9rqllz_EL4yS99vgcryecvXP9O3l4BAAA">
<CodeGroup>
```python Python icon="python"
