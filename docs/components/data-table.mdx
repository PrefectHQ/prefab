...
<ComponentPreview json={{"view":{"type":"DataTable","columns":[{"key":"id","header":"ID","sortable":false},{"key":"task","header":"Task","sortable":true},{"key":"status","header":"Status","sortable":false}],"rows":[{"id":"T-001","task":"Design system","status":"Complete"},{"id":"T-002","task":"API integration","status":"In Progress"},{"id":"T-003","task":"Testing","status":"Pending"},{"id":"T-004","task":"Documentation","status":"In Progress"},{"id":"T-005","task":"Deployment","status":"Pending"}],"searchable":false,"paginated":true,"pageSize":3}}} playground="H4sIABtduGkC_52RwWrDMAyG73kK41MLXmnX7TLIYTSX3ALLbYziJmpmmtjBUhjZ2LvPTkLnjLWD6WLrl_XxWzpa07DWwlEe9p1aFaZpjQZNyJS7WWKJJJnLQw3i-7ozddfoKDoLi4i5KAYZ4-ch8_GjY3GCPuaq5IK9gizBxjxN-FJcf08ST0FHPqbozPmXcW47-AuBJKnDAPI0ClPfy3hY8xaa__BOHxjPb9brjesdjTghAVSVZtgjQeMLE96Vdm5-NRDwT_Er5zbkPGYpU5qgspKU0XNSqllmTWUB8RJsG8JyQFK6mkMy0KUXLwDuZr8yRde4zf_Py_18QG1teg-7amcaeysrpSVBOazyrMEe1TvEWxEtoy8SxEsfpgIAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DataTable, DataTableColumn
