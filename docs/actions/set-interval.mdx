...
Button(
    ...
    on_click=[
        ...
        SetInterval(
            ...
            on_complete=[
                ShowToast(
                    "Plot twist: the timer was watching"
                    " YOU the whole time.",
                    variant="info",
                ),
    ...
    "onClick": [
      ...
      },
      {
        ...
        "onComplete": [
          {
            "action": "showToast",
            "message": "Plot twist: the timer was watching YOU the whole time.",
            "variant": "info"
          },
          {
            "action": "setState",
