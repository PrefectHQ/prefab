...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"name":"slider_21","type":"Slider","min":0.0,"max":100.0,"value":50.0,"disabled":false},{"content":"Volume: {{ slider_21 }}%","type":"Text"},{"type":"Progress","value":"{{ slider_21 }}","min":0,"max":100,"variant":"default"}]},"state":{"slider_21":50.0}}} playground="H4sIAAAAAAAC_z3NTQrCMBAF4H1OMRSEBEKJiJtCVl6goLiVqJMaaJIySbUg3t3-6WxmFt97Yyl66AituV56V96i72LAkBO48aIMh9j2PkioKTaEKUk4tu6OJOGEQ2bs5fJjRbwxnd6JisE4aVagV86fpu1R75UE74Kelhn0Vikx66mL2-I89WAF7yVd0vDZFIv4_V-L_kCwLwwpKzDDAAAA">
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"cssClass":"gap-3 items-center","type":"Row","children":[{"name":"active","type":"Switch","checked":false,"size":"default","disabled":false,"required":false},{"content":"{{ active ? 'Online' : 'Offline' }}","type":"Text"}]}]},"state":{"active":true}}} playground="H4sIAAAAAAAC_2WOwYrDMAxE7_4K4ZMNJoftreDTfkBht_fgBrkRJLJxlG0_v46TLiyrkxjNvFEsaYZcMIZbv1IXcgaacyoCC0pPTEJh6hcJgir-9Q6pGhlZlnfkM03rzA6-0sPB94NkGB1c8SlKNQL4_1QTBqEf9NeyolWqhsaDY-4h-w97VlCn6ZXbxJODMNGdvR5qPRZ9mLbZaw2HGb3e2dr-XrdnTOvt9lsnI7LRF56IUTvQlxjbaq16AfSgJ24cAQAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import set_initial_state
