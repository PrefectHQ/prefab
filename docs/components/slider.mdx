...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Column","children":[{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Storage Used"},{"cssClass":"pf-slider-flat","name":"slider_16","type":"Slider","min":0,"max":100,"value":85.0,"disabled":false,"size":"default","indicatorClass":"bg-red-500"}]},{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Upload Progress"},{"cssClass":"pf-slider-flat","name":"slider_17","type":"Slider","min":0,"max":100,"value":45.0,"disabled":false,"size":"default","indicatorClass":"bg-blue-500"}]}]},"state":{"slider_16":85.0,"slider_17":45.0}}} playground="">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Column, Label, Slider
