...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Form","children":[{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Username"},{"name":"username","type":"Input","inputType":"text","placeholder":"Username","disabled":false,"readOnly":false,"required":true}]},{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Email"},{"name":"email","type":"Input","inputType":"email","placeholder":"Email","disabled":false,"readOnly":false,"required":true}]},{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Age"},{"name":"age","type":"Input","inputType":"number","placeholder":"Age","disabled":false,"readOnly":false,"required":true,"min":0.0,"max":150.0}]},{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Password"},{"name":"password","type":"Input","inputType":"password","placeholder":"Password","disabled":false,"readOnly":false,"required":true}]},{"name":"active","type":"Checkbox","label":"Active","checked":true,"disabled":false,"required":false}]}}} playground="H4sIALNZt2kC_02OwQqDMAyG732KHBVEtsMugpcdvA0GbmepbZRC20haN_b2ax3bzC358yXfxORgeWnpo1Fg3EIc4SwDXkijraAzaHUFPSrG2EcW0wYwTnIcVlMrSohHH8MX7oidEMrKEOAekK9Mk7FY_I6WjYBUa8q8dNhASGfzBJ009t_KOWXGR2g_FsWM7aECi-3xdCi3lSU9eRLrZie4oSqaR6JHIpvwG68oRBars_7gskaxkyvFG1fm8xcIAQAA">
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Form","children":[{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Your Name"},{"name":"name","type":"Input","inputType":"text","placeholder":"How should we address you?","disabled":false,"readOnly":false,"required":true,"minLength":2,"maxLength":50}]},{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Bio"},{"name":"bio","type":"Textarea","placeholder":"Tell us about yourself","value":"","rows":3,"disabled":false,"required":false}]}]},"state":{"bio":""}}} playground="H4sIALNZt2kC_3WQMWvDMBCFd_-KQ1MMJpSWLgFT6BC6tHTo0snI1rlWkXTmdMIJIf-9stMEL7lBiE_v7p5ez-RhPBodxHZg_Ugs8KojvpNBV8HeojNFv6gYe902yW47yrqAQeK1Y0_si6JzOkb4ZOqtw81tSrkrIFfQHncQhaG-jN0seC6x4rBW35QYPrJMVbcng7FjO4qlUKs3miAOlJyBCUEbw5gXHim9rDq8DY3D8CND_bii-nClzw8XXC5na-mOK5P_m5zU6p6dL3QOUgTdUpLZBkd0_Ur9Gyk0sRvQ6wYPwro-qWTVDk5KjiPmi5LMNaNWFSimKWb2dD5fDRZzsNs5_sbPUW7-wy2LP0whR-i5AQAA">
<CodeGroup>
```python Python icon="python"
from pydantic import BaseModel, Field
from prefab_ui.components import Form
