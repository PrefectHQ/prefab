...
from prefab_ui.components.base import Component as _C

from prefab_ui.components.base import ContainerComponent as _CC
...
def _execute_prefab(_code, _data):
    ...
    # Find result: prefer PrefabApp, then root components (not children of any container)
    ...
    # Filter to roots — components that aren't children of any other component
    _all_children = set()
    for _c in _comps:
    ...
    return {"version": "0.2", "view": _target.to_json()}
`;
...
`);
    ...
    // Extract the last meaningful line from Python traceback
