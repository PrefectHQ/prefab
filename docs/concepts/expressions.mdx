...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"content":"Total items: {{ todos | length }}","type":"Text"},{"content":"Done: {{ todos | selectattr:done | length }}","type":"Text"},{"content":"Remaining: {{ todos | rejectattr:done | length }}","type":"Text"}]},"state":{"todos":[{"name":"Learn Prefab","done":true},{"name":"Build dashboard","done":false},{"name":"Deploy to production","done":false}]}}} playground="">
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import set_initial_state
