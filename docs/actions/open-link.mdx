...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"name":"repo","type":"Input","inputType":"text","placeholder":"owner/repo","disabled":false,"readOnly":false,"required":false},{"type":"Button","label":"Open on GitHub","variant":"default","size":"default","disabled":false,"onClick":{"action":"openLink","url":"https://github.com/{{ repo }}"}}]}}}>
<CodeGroup>
```python Python icon="python"
