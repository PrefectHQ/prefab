...
<ComponentPreview json={{"view":{"type":"Button","label":"{{ waiting ? 'Waiting\u2026' : 'Start 3 second timer' }}","variant":"default","size":"default","disabled":"{{ waiting | default:false }}","onClick":[{"action":"setState","key":"waiting","value":true},{"action":"setInterval","duration":3000,"count":1,"onComplete":[{"action":"showToast","message":"Three seconds. An eternity for a brain the size of a planet.","variant":"info"},{"action":"setState","key":"waiting","value":false}]}]}}} playground="H4sIAAAAAAAC_21Qy27CMBC8-ytWPjlSFKXinEN7qNRrQeqhqpBJNsXCrJG9AdpTv6Yf1i-pAzaFwpw845l99d6tYeOx14v5YKrWrTeOkDiAiS_P8DAwOxL9pU-3bBydTFPkJ2L0W23LkUxZM8bX0u1mTgf-H_f7nHzeC7HThg29QxOZkonJQohjbyUgIskVL5GUfDmyn69vWYKM7WKpCQRsHXXAZo1eFuUh15mgFxa7Jhfo4hCDZfWobcBkcjRvrWlXzeuBjshbqJQrYeaH7E-GvLM6iSMmdV2XF0rrBuLm7lIce8ZrW2Q8a3uqnk-nrr5GyNnSI6aFQwX3BLGOJ8Mf0Dsvb4dAw8JrQxCPCMF8Irg-ahurCbmS5c3UVnuj4_jSUO9ueIpr6fp258fOePuj6ScqhfgF8fTBiJICAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 items-center","type":"Column","children":[{"cssClass":"text-2xl font-mono","content":"{{ seconds > 0 ? 'T-minus ' + seconds + '\u2026' : 'Ready for launch' }}","type":"Text"},{"type":"Button","label":"{{ seconds > 0 ? 'Counting down' : 'Begin countdown' }}","variant":"default","size":"default","disabled":"{{ seconds > 0 }}","onClick":[{"action":"setState","key":"seconds","value":10},{"action":"setInterval","duration":1000,"while":"{{ seconds > 0 }}","onTick":{"action":"setState","key":"seconds","value":"{{ seconds - 1 }}"}}]}]}}} playground="H4sIAAAAAAAC_32RvW6DMBDHd57i5AkUE5GqUyU6JFPXJFtVRY4xwao5I3w0dOvT9MH6JMVp3EBS9QZzX3_fj3PZ2hqaVpViv-v0XNq6saiQHOjBawmWHZFFDitrunr4blVPUTlVCUna4q9ko-gJSbVvwnAfbEiQuta0fWhf91HklLRYOMiHKGbniCVRdNRUnWfHB9Hk9xykcztphHM506Rql0rlp7HkIYLBPGB88rzF4eZHyJI5VQovNW9sm9YaOwcMZhB6Z8C-Pj4Zn3aulSjeobQtGNGhrEb15OKO6GggSe96M2iQ0tqiPUuS0_mz2X9R2cp2SBoPUNgjMg5sqQ4aQfr0KTWaXGgn9kYV-eieS9XigKXla_48-avwPGE4h0WW8OuW8JzT3XlbZFnGb7LHShu1-xtkBESe55YgyFJYXKGMwpewym_fEsGYwgIAAA">
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 items-center","type":"Row","children":[{"type":"Button","label":"Start","variant":"default","size":"default","disabled":"{{ running | default:false }}","onClick":[{"action":"setState","key":"running","value":true},{"action":"setState","key":"ticks","value":0},{"action":"setInterval","duration":1000,"while":"{{ running }}","onTick":{"action":"setState","key":"ticks","value":"{{ ticks + 1 }}"}}]},{"cssClass":"text-2xl font-mono tabular-nums","content":"{{ ticks | default:0 }}","type":"Text"},{"type":"Button","label":"Stop","variant":"outline","size":"default","disabled":"{{ !running }}","onClick":{"action":"setState","key":"running","value":false}}]}}} playground="H4sIAAAAAAAC_21RPW_DIBDd-RWIyVZx5FSdKnnpUKlr0q2qIuLgBhUfFhyJp_72gmM7JM4N6L4e9-5eY01LOysbsd95tapN2xmQgI6q4Fmkbx7RAKcbc-b0U_ZImluIqFEZmPu3Ej8ApT0JzWOwRYHyHmP7qX3TE2I9gIIfWoUoY2PEcoKq_nVjdvBDjpwVHiOZ7Ed01QuntXO7WgvnKqZQtq6oZRzP8ldCg13oZ4MfjQU-FhmfEwflxF7LQzXOXR0CSa8xexfayfzaaCDMCSyqrzkVbVoxG_HhSNanuJumYQ1Oy2V9Olp2U4i2LsuSL7Lno9JyN7Fe1gPdOKy6H3056hNd31FIwu-Lmw9vlPzKaUDPJ0rXSHTAACmee00bA1i0BgxFsfda2AJ861j6_QN9TJfIcxJWCcCKGY9agXyk3N_iCLNWS3VSWXPyD8yFwmD_AgAA">
<CodeGroup>
```python Python icon="python"
