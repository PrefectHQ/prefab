...
<ComponentPreview json={{"view":{"type":"Metric","label":"Revenue","value":"${{ revenue / 1000000 | round:0 }}M"},"state":{"revenue":42000000}}} playground="">
<CodeGroup>
...
Metric(label="Revenue", value=f"${(revenue / 1_000_000).round()}M")
```
