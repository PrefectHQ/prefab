...
<Card icon="braces" title="Badge Protocol">
<ParamField body="cssClass" type="string | null">
  CSS/Tailwind classes for styling
</ParamField>

<ParamField body="type" type="Badge" default="Badge">
...
<ParamField body="variant" type="string" default="default">
  Visual variant: default, secondary, destructive, outline, ghost, success, warning, or info. One of: `"default"`, `"secondary"`, `"destructive"`, `"success"`, `"warning"`, `"info"`, `"outline"`, `"ghost"`
</ParamField>
