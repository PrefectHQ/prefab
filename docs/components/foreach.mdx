...
<ComponentPreview auto json={`{"view":{"cssClass":"gap-2","type":"Row","children":[{"type":"ForEach","key":"tags","children":[{"type":"Badge","label":"{{ $item }}","variant":"secondary"}]}]},"tags":["earth","magrathea","vogon poetry","42"]}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    ForEach,
...
<ComponentPreview auto json={`{"view":{"cssClass":"gap-1","type":"Column","children":[{"type":"ForEach","key":"steps","children":[{"type":"Text","content":"{{ $index + 1 }}. {{ $item }}"}]}]},"steps":["Collect underpants","?","Profit"]}`}>
<CodeGroup>
```python Python icon="python"
