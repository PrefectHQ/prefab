...
<ComponentPreview json={{"view":{"type":"Alert","variant":"default","children":[{"type":"AlertTitle","content":"Heads up!"},{"type":"AlertDescription","content":"You can add components to your app using the CLI."}]}}} playground="H4sIABtduGkC_22OMQvCMBSE9_yKs1MKpT_ATXRQcHRxkti82gdtXkheEP-9AQeLeNN3HHfcmGRBTDS6-61wP8gSJVDQDK6UFNagajdT0u6LF9aZVv5AeUgclSV0pjXmyTp9Ettuf2q2OZLzGSVumvbvhG2uUjC4AOc9Vp9U8JKS4GJEyRwe0ImwP5_6uvQGVqIEDcsAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"type":"Alert","variant":"default","children":[{"type":"AlertDescription","content":"Your changes have been saved."}]}}} playground="H4sIABtduGkC_23KMQrDMAyF4V2nEJlsCDlAt0IvkSk4rlILGsnISnr9Gjpk6Zs-eP9mumM12tK6HDxl3asKiTfkLnMMgH33N5mPFx_UsnF1VhkhAnzYy-8J8fY3C8Osh2EuSV7UsKSTcCUSbF3PaYjwBfhj99WLAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Alert,
