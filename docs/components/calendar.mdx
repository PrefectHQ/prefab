...
<ComponentPreview auto json={`{"type":"Calendar","mode":"range","name":"dateRange"}`}>
<CodeGroup>
```python Python
import json
from prefab_ui.components import Calendar
...
<ComponentPreview auto json={`{"type":"Calendar","mode":"multiple","name":"selectedDates"}`}>
<CodeGroup>
```python Python
import json
from prefab_ui.components import Calendar
...
<ComponentPreview auto json={`{"cssClass":"gap-6","type":"Row","children":[{"type":"Calendar","mode":"single","name":"selectedDate"},{"cssClass":"gap-2","type":"Column","children":[{"type":"Text","content":"Selected date:"},{"type":"Text","content":"{{ selectedDate | date:long }}","bold":true},{"content":"Raw: {{ selectedDate }}","type":"Muted"}]}]}`}>
<CodeGroup>
```python Python
