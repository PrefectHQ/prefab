...
<ComponentPreview json={{"view":{"type":"Column","children":[{"content":"Content above the separator","type":"P"},{"cssClass":"my-4","type":"Separator","orientation":"horizontal"},{"content":"Content below the separator","type":"P"}]}}} playground="H4sIABtduGkC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUNLgUgMA5P6c0N08HzA6AUMGpBYlFiSX5RTpcmlxc5ZklGVBVGppWEHUaSs75eSVAwxQSk_LLUhVKMlIVimG6lDRRTdEoLkhMzsxLtzXRRNedlJqTX46hGwBOJ4hLugAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 items-center","type":"Row","children":[{"type":"Span","content":"Left"},{"cssClass":"h-4","type":"Separator","orientation":"vertical"},{"type":"Span","content":"Middle"},{"cssClass":"h-4","type":"Separator","orientation":"vertical"},{"type":"Span","content":"Right"}]}}} playground="H4sIABtduGkC_62OwQqDMBBE7_mKkFME7clTwT9oL_YDZBtXXdAkbNb6-43SFrx3TjMw85iBw6Ij4wDPbqWLC0sMHr0kTdmxaKt0Vhu28jAPjMAggT8xgi9VodRGMu0tO0Js6lK7lDo3Q0qNIcElVS5DkU1x_e2sueEgpjhzbWDKVRAKvjEvZCEHszkRp6r-zg7Onfp-xn-QWhqn_dIbAZAotRcBAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Row,
...
<ComponentPreview json={{"view":{"type":"Card","children":[{"type":"CardContent","children":[{"content":"First section","type":"P"},{"cssClass":"my-4","type":"Separator","orientation":"horizontal"},{"content":"Second section","type":"P"},{"cssClass":"my-4","type":"Separator","orientation":"horizontal"},{"content":"Third section","type":"P"}]}]}}} playground="H4sIABtduGkC_52MsQ7CMAxE93yF1SmRKiYmJKZKzEhlRyFNqYfakWPE7xOlEHXGi093924WXiFJnP3j_sJD4DUxRdIMWJQoWAPlBi9T39TApKWzGdftjTF58crSG2fMG3WpVetONW7Gl_35dcF2F5SskGNQZOpci9qqzckHpOf56PbcGAPT9Ad4W1D23Af0d-biCAEAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card,
