...
<ComponentPreview json={{"view":{"type":"Button","label":"Load Users","variant":"default","size":"default","disabled":false,"onClick":{"onSuccess":[{"action":"setState","key":"users","value":"{{ $result }}"},{"action":"showToast","message":"Users loaded!","variant":"success"}],"action":"fetch","url":"/api/users","method":"GET"}}}} playground="H4sIAAAAAAACE12OzQrCMBCE73mKmFOFYp-gF0FPPVl7Eikx3dqgZkuyUR_fmP5gndMwfMNMa_HBewutvNRebxQ-ejRgyHEdnCW-9URoWLvkpCKNZob2QKpLeQlUkiQIrsPXEaWj_6J9T53DrqyKI2PDQMJ4kChQNrxyYJ1IY4KmVnetbnmc2FyBBjLSmex15n_oseG8UuBcfprDr6Z3iRgr44V1usSm64mIR_g9fIJmFfintFoaysU4IH6q58GGZM0--7wtPVUBAAA">
<CodeGroup>
