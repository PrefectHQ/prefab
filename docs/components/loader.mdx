...
<ComponentPreview json={{"view":{"type":"Loader","variant":"spin","size":"default"}}} playground="H4sIAAAAAAACE0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUfPITU1KLuLggtIYmFwCF0vN_MgAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"type":"Loader","variant":"dots","size":"default"}}} playground="H4sIAAAAAAACE0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUfPITU1KLuLggtEZZYlFmYl6JrVJKfkmxkiYXAMOsA19AAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Loader
...
<ComponentPreview json={{"view":{"type":"Loader","variant":"pulse","size":"default"}}} playground="H4sIAAAAAAACE0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUfPITU1KLuLggtEZZYlFmYl6JrVJBaU5xqpImFwCWEgBQQQAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Loader
...
<ComponentPreview json={{"view":{"type":"Loader","variant":"bars","size":"default"}}} playground="H4sIAAAAAAACE0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUfPITU1KLuLggtEZZYlFmYl6JrVJSYlGxkiYXACkNmYlAAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Loader
...
<ComponentPreview json={{"view":{"type":"Loader","variant":"ios","size":"default"}}} playground="H4sIAAAAAAACE0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUfPITU1KLuLggtEZZYlFmYl6JrVJmfrGSJhcATHzqBD8AAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Loader
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 items-center","type":"Row","children":[{"type":"Loader","variant":"spin","size":"sm"},{"type":"Loader","variant":"spin","size":"default"},{"type":"Loader","variant":"spin","size":"lg"}]}}} playground="H4sIAAAAAAACE0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUgvLLdRR88hNTUou4uMozSzJAIhrpiQW2JjoKycXF8ck5icXFtkqZJam5xbrJQK2pRUqaVlwKQADRplGcWZVqq1Scq6SJKZoCtLk0pwSbVE46UBQA7GSq-qAAAAA">
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"cssClass":"gap-2 items-center","type":"Row","children":[{"content":"Agent is thinking","type":"Text"},{"type":"Loader","variant":"dots","size":"sm"}]}}} playground="H4sIAAAAAAACEyWMuw7CMAxF93yF5amVAgMjUgZ2JsRehdRtLchDsaGIryeFO12d-5hqjlAqTf42PHkfciw5UVIBbq4qXPJq4Zz9SNXCld5qzMq6bLybfXEHC0FkCA8v4pCVouxCO6CK_dFA0zbq8DQ3CCygC6c7pxn7X_q_7l6-sk_qcMwqaEH4Qw4lttYXlo3AyqMAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Row, Loader, Text
