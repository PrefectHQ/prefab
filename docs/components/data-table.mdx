...
<ComponentPreview json={{"view":{"type":"DataTable","columns":[{"key":"id","header":"ID","sortable":false},{"key":"task","header":"Task","sortable":true},{"key":"status","header":"Status","sortable":false}],"rows":[{"id":"T-001","task":"Design system","status":"Complete"},{"id":"T-002","task":"API integration","status":"In Progress"},{"id":"T-003","task":"Testing","status":"Pending"},{"id":"T-004","task":"Documentation","status":"In Progress"},{"id":"T-005","task":"Deployment","status":"Pending"}],"searchable":false,"paginated":true,"pageSize":3,"caption":"Sprint tasks"}}} playground="H4sIAL5FuGkC_52RwU7DMAyG732KKKdNKmgwuCD1gNZLb5XoDaHJa70SrU2i2BUqiHcnWavRIjYkckn8O_7yx9470wrrcA-7baeuS9Nao1EzCeVPjkUKDAXsGoy_jxvTdK2OopOwiIRf5VGm5PkYhfWjYnHAPpGqkrF4RajQJTJL5TK-fJ-BDpOKYgjJmws3k8J1-BeCGLijCeRpEMa6l2Fz5m1q_iM4fRCyuFqtbnztYMQLKZKqtaCeGNuQGPE-tfH9a5BRfsa_cm6nnMc8E0oz1g5YGT0nZVrkztQOic7B1lNYgcRK13NIjroK4hnA3exXpuxaP_n_ebmfN8g2pg-wi3bGtluolQbG6jjKk4ZbUu-YrAehBBt8-clZ53smwlN-oNEy-gJW5UJAwgIAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DataTable, DataTableColumn
...
<ComponentPreview json={{"view":{"type":"DataTable","columns":[{"key":"metric","header":"Metric","sortable":true},{"key":"trend","header":"Trend","sortable":false},{"key":"status","header":"Status","sortable":false}],"rows":[{"metric":"Revenue","trend":{"cssClass":"w-24","type":"Sparkline","data":[45,52,49,60,55,72,68,75],"variant":"success","fill":true,"curve":"linear","strokeWidth":1.5},"status":{"type":"Badge","label":"Growing","variant":"success"}},{"metric":"Churn","trend":{"cssClass":"w-24","type":"Sparkline","data":[12,15,18,14,20,22,19,25],"variant":"destructive","fill":false,"curve":"linear","strokeWidth":1.5},"status":{"type":"Badge","label":"At risk","variant":"destructive"}},{"metric":"Users","trend":{"cssClass":"w-24","type":"Sparkline","data":[200,220,215,240,260,255,270,290],"variant":"info","fill":true,"curve":"linear","strokeWidth":1.5},"status":{"type":"Badge","label":"Stable","variant":"secondary"}}],"searchable":false,"paginated":false,"pageSize":10}}} playground="H4sIAL5FuGkC_62TS2_CMAzH7_0UUU8gZYhGZQ-kHvaQdpo0DXZCaAqpCxElRU7KNE377nPKq7ANNLYcWtuN_7F_cTMsZmyOkMnRS6lbqpjNCwPGWabJQsfupJN9OcqBb83bIi9nhrMbmY4p_ojFGMHaIPtJrKUmEreavbnEaa4NBMFGsxEwWqpStsmg8vzaO7QxhbcknIFDrULOJiBTwCR8WAcs6fvdSR9LaPLDMg7BpDWVfuUfy7JOutLW0nrLwCpvuHxh8Vpv431j-bVuoMvCJ1iAKSHkuxuWpXW3qBo73_1KqbhkEHc46wjO4ivOzttkk39B_vklvTtD_iVtIVFL46iPUim6NWok03leAeNMWfuicmltEr6eiXivrOZelSsU3eUkNMJ76lqbMUl-OaWW-sGPY7mdlGhOhhIRgIhARAQhijkTBEb4GEESB6GkYB2WyukFXckfaVw7htpO6zTq8r8k8mwB7clERLtC4B8ejIi95edF-IERF966ah8io01W_Oes9Kr_dGdUQBUmlfj2DRqqrBl8AumtrgKtBAAA">
<CodeGroup>
