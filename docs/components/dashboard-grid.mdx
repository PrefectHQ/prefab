...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Dashboard","columns":3,"rowHeight":150,"children":[{"type":"DashboardItem","col":1,"row":1,"colSpan":2,"rowSpan":1,"children":[{"cssClass":"bg-blue-500 rounded-md h-full","type":"Div"}]},{"type":"DashboardItem","col":3,"row":1,"colSpan":1,"rowSpan":1,"children":[{"cssClass":"bg-emerald-500 rounded-md h-full","type":"Div"}]},{"type":"DashboardItem","col":1,"row":2,"colSpan":3,"rowSpan":1,"children":[{"cssClass":"bg-purple-500 rounded-md h-full","type":"Div"}]}]}}} playground="H4sIAL5FuGkC_52PzQqDMBCE7z5F6EnBFDV4KeTWS59CollNIH_kp75-YxFsD_XQvewOyzfDzN5q5DzMbBySvE5WO2vAxIBkvnxEdxbEaJnn9XE-Iugs5bMoVhnF8Sgnq5I2gZIaebsOAuQiIm37pkYLc5RUtwLl-aY2u42k7ZvaVlZDcMzQbie2yYHlFMIwKRYCvYwLHlUC3DdNxpLhwLHmSOA5KXWpzoLIHnRqDho8U_wf_71I91GEnGa55J36XeUF4LNvzaYBAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Dashboard, DashboardItem, Div
...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Dashboard","columns":3,"rowHeight":"auto","children":[{"type":"DashboardItem","col":1,"row":1,"colSpan":2,"rowSpan":1,"children":[{"cssClass":"h-full","type":"Card","children":[{"type":"CardContent","children":[{"content":"This card has a paragraph of content, so the first row expands to fit. The green cell to the right stretches to match, even though its own content is short.","type":"P"}]}]}]},{"type":"DashboardItem","col":3,"row":1,"colSpan":1,"rowSpan":1,"children":[{"cssClass":"bg-emerald-500 rounded-md h-full flex items-center justify-center","type":"Div","children":[{"cssClass":"text-white font-semibold","content":"Stretches","type":"Text"}]}]},{"type":"DashboardItem","col":1,"row":2,"colSpan":3,"rowSpan":1,"children":[{"cssClass":"bg-purple-500 rounded-md h-full p-3 flex items-center","type":"Div","children":[{"cssClass":"text-white","content":"Row 2 has less content, so it's shorter.","type":"Text"}]}]}]}}} playground="H4sIAL5FuGkC_41Sy27bMBC8-ysW6iEyIBmJhVwK6OReegta3w1aWolsSZHgUpFzy0f0C_slXTJKIjtJWx4kkvuaGU7nrQHnsRPHw6g2jTXODjgEAsU7HyBfAa-d8G2Rvjs7BI4X6fqLIHm0Kfay_RrQzFF1X8BdAXs8cf56tZpUkK-JeWP1aAaqqwK8nQ4SVS9DnYkx2KyAXri6Wn9OnT7BNzvBDfx-_AVBIjRcfkXghBe9F06CET-ROKQotoIgtE6F5xMjtDi1vkkT449PB3JiqLfzqJeqXYJIdGi0IKozWXaj1tki7Sx11iW_iMd1l2f7iCyiBikIxAK57RjDk6RANrHrlKeQeGRvegFkeGK8LbO1nBk2sOeS3iMO0KDW8To28VFMoOAxNJK1ebcV5xrB8QLwnuuDtGMvQfHr22l4xgUMnSR7YZOt_yZqNYt6KSTbYKnjsS_RoBe6LW-vr7lkHFpsS8PSJIWh03hiDGiobHg8evgxUlDdw3y8fIJorzz7_syUrbOYFjhYTpLbQcd0SkKjjla3TGXhrG1yViJ58RqzoaIEhk2F_j9stV3Yqvq3Gm70TuMHYriyeivI-wo8EYn-0kh0xkOFq_kN0W8-Eogl-QNodz-5DgQAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card, CardContent,
...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Dashboard","columns":6,"rowHeight":80,"children":[{"type":"DashboardItem","col":1,"row":1,"colSpan":4,"rowSpan":2,"children":[{"cssClass":"bg-blue-500 rounded-md h-full flex items-center justify-center","type":"Div","children":[{"cssClass":"text-white font-semibold","content":"Background panel","type":"Text"}]}]},{"type":"DashboardItem","col":3,"row":1,"colSpan":4,"rowSpan":2,"zIndex":1,"children":[{"cssClass":"h-full border-2 border-amber-500","type":"Card","children":[{"cssClass":"flex items-center justify-center h-full","type":"CardContent","children":[{"cssClass":"font-semibold","content":"Overlay (z_index=1)","type":"Text"}]}]}]}]}}} playground="H4sIAL5FuGkC_4WSPW_DIBCG9_yKk7s4kqny1aqqxNJ06dQlu4UxtmnBWIDz0V_fM3Fix0PCAAd3vHf3QGGNhsaKgmVpK5-50Y2pRe0dSLSsh3gGOLbM5kmYt6b26E_C8SdzVWaC72p-eaF7r9wnsBNHDJ7PZgfpqyEq5ka1unb0NQFrDmklZFl5-rZIoGQNXc3fg8QT7CrpoGG1UMDNXlgH_U1Ykk2IuRXu0nfidBmEuwV3qUMJujnnCvYlw6Ag9zF3LuWKOUejrCSZagV5WSzwUlvnIic6h4oUrVJQKHEEiakc4UhDWPhpnZfFqd9GI_VudBTi6IPx3zKInTuKsLYho8cYcqhQFQqETJzQMjMqj-ZjFBx7nJJYE6TYHSnWNLIuR467iNYPECXwl0rs_EiXU1rb8IZD8T2XzNhcWLK6GExnOCPDKZCrSP-fxlqP4PaPMJUcOH8HFCeIh_JvUU_5_gNEZ4uWBgMAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card, CardContent,
