...
<ComponentPreview auto json={`{"label":"Summarize","variant":"default","size":"default","disabled":false,"onClick":{"action":"sendMessage","content":"Please summarize the data above."},"type":"Button"}`} />

```python Send Message Hero
...
<ComponentPreview auto json={`{"gap":3,"type":"Column","children":[{"inputType":"text","placeholder":"Ask a follow-up question...","name":"question","disabled":false,"required":false,"type":"Input"},{"label":"Ask","variant":"default","size":"default","disabled":false,"onClick":{"action":"sendMessage","content":"{{ question }}"},"type":"Button"}]}`} />

```python Dynamic Messages
