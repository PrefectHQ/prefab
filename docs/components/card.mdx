...
<ComponentPreview json={{"view": {"cssClass": "p-6", "type": "Card", "children": [{"content": "Quick Stats", "type": "H3"}, {"content": "42 active connections, 3 pending requests.", "type": "P"}]}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card,
...
<ComponentPreview json={{"view": {"cssClass": "gap-4 grid-cols-3", "type": "Grid", "children": [{"type": "Card", "children": [{"type": "CardHeader", "children": [{"type": "CardDescription", "content": "Revenue"}, {"type": "CardTitle", "content": "$12,450"}]}]}, {"type": "Card", "children": [{"type": "CardHeader", "children": [{"type": "CardDescription", "content": "Users"}, {"type": "CardTitle", "content": "1,234"}]}]}, {"type": "Card", "children": [{"type": "CardHeader", "children": [{"type": "CardDescription", "content": "Uptime"}, {"type": "CardTitle", "content": "99.9%"}]}]}]}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card,
