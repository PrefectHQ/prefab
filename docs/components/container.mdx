...
<ComponentPreview json={{"view":{"cssClass":"max-w-2xl","type":"Container","children":[{"content":"The ships hung in the sky in much the same way that bricks don't.","type":"P"}]}}} playground="H4sIAAAAAAAC_0WKMQ6DMBAEe7_i5CYgBYqUkVLlAxTp0eGY-AQ-I58t4PfBScE0uzvaMQYPS7QjDn2m1gS_BLacBOhoMcEzcEJiG6_QKbVScqeqjEhvZhR5aI9bsza3bdb1XcFBV_2ioF_OgjhaBFzmDxBDKmbaS_XZuLL1-QdBb2HF_fCYYIhkJoF34Etq_7dafQG-QmGIugAAAA">
<CodeGroup>
```python Python icon="python"
