...
<ComponentPreview json={{"view":{"cssClass":"gap-3 items-center","type":"Row","children":[{"type":"Button","label":"-","variant":"outline","size":"default","disabled":false,"onClick":{"action":"setState","key":"count","value":"{{ count - 1 }}"}},{"content":"{{ count }}","type":"Text"},{"type":"Button","label":"+","variant":"outline","size":"default","disabled":false,"onClick":{"action":"setState","key":"count","value":"{{ count + 1 }}"}}]},"state":{"count":0}}} playground="H4sIABtduGkC_6WOzW7CMAzH73kKK6dUFATiNqmXPQLsXnlRCtaKHaXuQEJ996VFBQHH-WT5__Fzk-QEMYUGv-ueVhgj0ClKUuiC1sSkhG3dKWowzbPXSzZyYO3myGevKlzCTs4lfIWLvkbQKwnf_fug-6nZvMGcl561WhfGnEmPY6U7YKy2JWBLB66sz-SQbPFhIM8N7ezSlvCLiTCHrfTaEod8Eq59S_6nmpHOToAs2esVph2WsIFhsEUxNY7_u4c4Ck-kxT9IizvpD3GawUiAAQAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"name":"name","type":"Input","inputType":"text","placeholder":"Your name","disabled":false,"readOnly":false,"required":false},{"content":"Hello, {{ name }}!","type":"Text"}]},"state":{"name":"Arthur"}}} playground="H4sIABtduGkC_2WNuwrCQBBF-_2KcasEFhs7IYXYaG9jFcY4MQv7GDazKIT8u8mihTjFbc65d_oUPXCiHm9ttltkBus5JoGRpLXBikXXjoJCqv91u7iIgYKM38oxuuyDgXPgLAYu9BKl_naqgJ4afUgy5KRrpZ5Whk-3eiA3u3qvYLky87HX1AbYYUdDdHdKjb7GnKCAuvjrv0qfyLloYJoKgnneLPgNdsPwa-cAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import set_initial_state
