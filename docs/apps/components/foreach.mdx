...
<ComponentPreview auto json={`{"_tree":{"key":"users","type":"ForEach","children":[{"type":"Card","children":[{"type":"CardHeader","children":[{"cssClass":"items-center","gap":2,"type":"Row","children":[{"content":"{{ name }}","type":"CardTitle"},{"label":"{{ role }}","variant":"secondary","type":"Badge"}]},{"content":"{{ email }}","type":"CardDescription"}]}]}]},"users":[{"name":"Alice","role":"Admin","email":"alice@example.com"},{"name":"Bob","role":"Editor","email":"bob@example.com"},{"name":"Carol","role":"Viewer","email":"carol@example.com"}]}`} />
...
<ComponentPreview auto json={`{"_tree":{"gap":2,"type":"Row","children":[{"key":"tags","type":"ForEach","children":[{"label":"{{ _item }}","variant":"secondary","type":"Badge"}]}]},"tags":["python","mcp","prefab-ui","async"]}`} />
