...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Calendar","mode":"single","name":"selectedDate"}}`}>
<CodeGroup>
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Calendar","mode":"range","name":"dateRange"},"state":{"dateRange":"{\\"from\\": \\"2025-06-10T12:00:00.000Z\\", \\"to\\": \\"2025-06-20T12:00:00.000Z\\"}"}}`}>
<CodeGroup>
```python Python icon="python"
import json
from prefab_ui.components import Calendar
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Calendar","mode":"multiple","name":"selectedDates"},"state":{"selectedDates":"[\\"2025-06-10T12:00:00.000Z\\", \\"2025-06-15T12:00:00.000Z\\", \\"2025-06-22T12:00:00.000Z\\"]"}}`}>
<CodeGroup>
```python Python icon="python"
import json
from prefab_ui.components import Calendar
...
For the complete protocol schema, see the [Calendar protocol definition](/protocol/calendar).
