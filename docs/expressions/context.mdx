...
<ComponentPreview auto json={`{"view":{"cssClass":"gap-3","type":"Column","children":[{"type":"Text","content":"Inventory: {{ inventory }}"},{"type":"Slider","min":0.0,"max":30.0,"step":1.0,"name":"inventory","disabled":false,"onChange":{"action":"setState","key":"inventory","value":"{{ $event }}"}},{"type":"Condition","cases":[{"when":"inventory == 0","children":[{"type":"Alert","variant":"destructive","children":[{"type":"AlertDescription","content":"Out of stock!"}]}]},{"when":"inventory > 0 && inventory < 10","children":[{"type":"Alert","variant":"default","children":[{"type":"AlertDescription","content":"Low stock warning"}]}]}]}]},"inventory":15}`}>
<CodeGroup>
```python Python icon="python"
