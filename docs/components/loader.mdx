...
<ComponentPreview json={{"view":{"type":"Loader","variant":"spin","size":"default"}}} playground="H4sIABtduGkC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUfPITU1KLuLggtIYmFwCF0vN_MgAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"type":"Loader","variant":"dots","size":"default"}}} playground="H4sIABtduGkC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUfPITU1KLuLggtEZZYlFmYl6JrVJKfkmxkiYXAMOsA19AAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Loader
...
<ComponentPreview json={{"view":{"type":"Loader","variant":"pulse","size":"default"}}} playground="H4sIABtduGkC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUfPITU1KLuLggtEZZYlFmYl6JrVJBaU5xqpImFwCWEgBQQQAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Loader
...
<ComponentPreview json={{"view":{"type":"Loader","variant":"bars","size":"default"}}} playground="H4sIABtduGkC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUfPITU1KLuLggtEZZYlFmYl6JrVJSYlGxkiYXACkNmYlAAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Loader
...
<ComponentPreview json={{"view":{"type":"Loader","variant":"ios","size":"default"}}} playground="H4sIABtduGkC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUfPITU1KLuLggtEZZYlFmYl6JrVJmfrGSJhcATHzqBD8AAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Loader
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 items-center","type":"Row","children":[{"type":"Loader","variant":"spin","size":"sm"},{"type":"Loader","variant":"spin","size":"default"},{"type":"Loader","variant":"spin","size":"lg"}]}}} playground="H4sIABtduGkC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUgvLLdRR88hNTUou4uMozSzJAIhrpiQW2JjoKycXF8ck5icXFtkqZJam5xbrJQK2pRUqaVlwKQADRplGcWZVqq1Scq6SJKZoCtLk0pwSbVE46UBQA7GSq-qAAAAA">
<CodeGroup>
```python Python icon="python"
