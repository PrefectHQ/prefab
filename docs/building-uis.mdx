...
```json Protocol icon="brackets-curly"
{
  "view": {
    "type": "Column",
    "children": [{"content": "first", "type": "Text"}, {"content": "second", "type": "Text"}]
  }
}
```
</CodeGroup>
        ...
        "children": [
          {
            ...
            "children": [
              {
                "type": "Row",
                "children": [{"content": "left", "type": "Text"}, {"content": "right", "type": "Text"}]
              },
              {"content": "below the row", "type": "Text"}
            ]
          }
        ]
      }
...
```json Protocol icon="brackets-curly"
{
  "view": {
    ...
    "type": "Column",
    "children": [
      {"type": "Badge", "label": "api-server", "variant": "default"},
      {"type": "Badge", "label": "worker", "variant": "destructive"},
      {"type": "Badge", "label": "scheduler", "variant": "default"}
    ]
  }
}
```
...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"content":"Hello, {{ name }}!","type":"H3"},{"type":"Input","inputType":"text","placeholder":"Your name...","name":"name","disabled":false,"required":false}]}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import PrefabApp
