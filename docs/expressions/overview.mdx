...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"name":"name","type":"Input","inputType":"text","placeholder":"Your name","disabled":false,"readOnly":false,"required":false},{"content":"Hello, {{ name }}!","type":"Text"}]},"state":{"name":"Arthur"}}} playground="H4sIALNZt2kC_2WNuwrCQBBF-_2KcasEFhs7IYXYaG9jFcY4MQv7GDazKIT8u8mihTjFbc65d_oUPXCiHm9ttltkBus5JoGRpLXBikXXjoJCqv91u7iIgYKM38oxuuyDgXPgLAYu9BKl_naqgJ4afUgy5KRrpZ5Whk-3eiA3u3qvYLky87HX1AbYYUdDdHdKjb7GnKCAuvjrv0qfyLloYJoKgnneLPgNdsPwa-cAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import set_initial_state
