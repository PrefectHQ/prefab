...
<ComponentPreview json={{"view":{"name":"dropzone_1","type":"DropZone","multiple":false,"disabled":false}}} playground="H4sIABtduGkC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUXIryC6KAQlxcMJaGJhcA8fV4vTYAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"name":"dropzone_2","type":"DropZone","icon":"image","label":"Drop images here","description":"PNG, JPG, or GIF up to 10MB","multiple":false,"disabled":false}}} playground="H4sIABtduGkC_zWLwQrCMBBE7_mKISeFIvoBvYhYFJSevUgat7rQZMMm_X_TQucwDG9mRpWApDS64T3zwUtIEimWDK5JCy4q6VWRMVvaGVSxl9haDu5LtlnJ5AaaWrvMsPKMH-nWfih75VR4ufXPrsG9ryaK7nbFnFAEp-PjXOd78wcq8kIIlgAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DropZone
...
<ComponentPreview json={{"view":{"name":"dropzone_4","type":"DropZone","label":"Upload files","description":"Select as many as you like","multiple":true,"disabled":false}}} playground="H4sIABtduGkC_zWKMQ4CMQwE-7zCSgXSiR-k4wdAQ4NyOUeycGLLSYr7_QUE2-xodrNJATXMcX0NuiQpKhVrb0CTrMPVRJ9TOfenk4MZjity8A9liRtkYmx--S4btmSknaQGf0PG1CE2KLHun95lANMbf-8yuJMyhrsNXNzZHUq59v6SAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DropZone
...
<ComponentPreview json={{"view":{"name":"dropzone_5","type":"DropZone","label":"Uploads disabled","multiple":false,"disabled":true}}} playground="H4sIABtduGkC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUXIryC6KAQlxcMJZGTmJSao6tUmhBTn5iSrFCSmZxYlJOaoqSDpxpG1JUmqrJBQBeS9maXQAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DropZone
...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"name":"dropzone_6","type":"DropZone","label":"Drop files to try it","multiple":true,"disabled":false},{"type":"Condition","cases":[{"when":"{{ dropzone_6 | length }}","children":[{"cssClass":"gap-2","type":"Column","children":[{"cssClass":"text-sm font-medium","content":"{{ dropzone_6 | length }} file(s) selected","type":"Text"},{"let":{"_loop_2":"{{ $item }}","_loop_2_idx":"{{ $index }}"},"type":"ForEach","key":"dropzone_6","children":[{"cssClass":"gap-2 items-center","type":"Row","children":[{"type":"Badge","label":"{{ $item.type }}","variant":"secondary"},{"content":"{{ $item.name }}","type":"Small"},{"content":"{{ $item.size }} bytes","type":"Muted"}]}]}]}]}],"else":[{"content":"No files selected yet","type":"Muted"}]}]}}} playground="H4sIABtduGkC_21SPW_CMBDd8ytOVgdHMgztVilLWyoxtEPL1AWZ5AKW_BHZl0JA_Pc6JkSh4oYoPr_37vnuau8MNB5ruVm3al460ziLlgKo-OcJeAYxXmS1RQGvTrfGCnjzrvmJOAHvzi9kuRMJtawFLHSI6Y-WsBLw5fYCvo3UWsAKDySyPMv2inaDEt_KpnjKnxP7GAWhGLUvhfvQcoO6YP0F1EpjAHJAvgNFTIwo02pSjcZi5Vu8pPP0TfWWNa_ZqS8x94e5RrulHc_PbKg94ia-Hid3ffQP4DeZPu6pJpc85BBQYxk7MbF5jTKEdallCAWjKDwLBmpnaWawUq35R8hvTsno0Hg-FP_ndYTFCVweI0BqtbUFK-N00bM7hHHQnJ1O8KAIzZy6BuF8ZgJ-pVfSUsECls5W0ncsvyuR5j2RsNIkifvotCkTdFDHHg2bjjCwyQT7xeIT1wPx0w07ce01dEiR9wedCjzP2QIAAA">
<CodeGroup>
```python Python icon="python"
