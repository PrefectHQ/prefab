...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Column","children":[{"content":"Starship Registry","type":"Heading","level":3},{"type":"Slot","name":"info"}]},"state":{"info":{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardTitle","content":"Heart of Gold"},{"type":"CardDescription","content":"Infinite Improbability Drive equipped"}]}]}}}}>
<CodeGroup>
