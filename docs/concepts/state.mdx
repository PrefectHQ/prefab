...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"name":"name_input","type":"Input","inputType":"text","placeholder":"Type your name..","disabled":false,"readOnly":false,"required":false},{"content":"Hello, {{ name_input | 'stranger' }}!","type":"Text"}]}}} playground="H4sIAP9SuGkC_02NMQ-CMBCFd37F2QVIGhY3k04uurOTigc0aXvN0UYJ8t8FNNGbXu69772OyUFg7PStSaZqyQXy6OMIZlUc4Uw2OS_h6kOKEmp8xix7mDh8naLXQR3LUwbree2wMVsS1IcotpcSP0NICFa3OJC9IytRTwFhosQ7XFWi3Ju2nUJc0FqSMM__zS_Ix8ja98g5LMthJd7bs9etxgAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardTitle","content":"{{ profile.name }}"},{"type":"CardDescription","content":"{{ profile.title }}"}]}]},{"type":"Field","invalid":false,"disabled":false,"children":[{"type":"Label","text":"Name"},{"name":"profile.name","type":"Input","inputType":"text","placeholder":"Name","disabled":false,"readOnly":false,"required":false}]},{"type":"Field","invalid":false,"disabled":false,"children":[{"type":"Label","text":"Title"},{"name":"profile.title","type":"Input","inputType":"text","placeholder":"Title","disabled":false,"readOnly":false,"required":false}]}]},"state":{"profile":{"name":"Arthur Dent","title":"Sandwich Maker, Lamuella"}}}} playground="H4sIAP9SuGkC_4VQS2uEMBC--ytCThFkL70teChdSgvbXtq7zOpYh8YkxMgexP_ePBTdLrQ5hGRmvvkerdU9MxZbuFQjHcAYRr3R1rEBXUWKHIGsBgcOs_Z2ttZ-UKFywwoRGfPnCWxTxPuEQ23JONIqFV4QGrTp_UlOYpEQWo69H3kmlB76qszoCnaGC8oiy7PsTkoiMla3JLGc4i8crqBHfmT80bputOzk1fFia7vAGfofoJor1R17g-8g6Az9iFLCMjxH2iu5btEmvsCUD_kxdlPdWxBL4aaYPO5bayjRseDTtCo_BLlsnnl-N7uL7gYRHWyQyBpj2xPG5AR_D2Fsq2OsIlCWfC-AF8xIqLHT0gsv97A_10c7_-xPgf8iWIE_ETpRiHwCAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import set_initial_state
...
<ComponentPreview json={{"view":{"type":"Column","children":[{"name":"brightness","type":"Slider","min":0.0,"max":100.0,"disabled":false},{"type":"Watch","key":"brightness","onChange":{"action":"setState","key":"brightness_pct","value":"{{ brightness / 100 }}"}},{"content":"{{ brightness_pct | percent }}","type":"Text"}]}}} playground="H4sIAP9SuGkC_1XPzQqDMAwH8HufIniqIJu7DjztERzsKLWLWrCp1MgE57uv6r7sJZD88ietvLPQeaxUWQzmoDQbRz0Y2znPkCPnrBhFtWfahTkh8VdeXDtYSiBvzR19AlccOYGbYt0I8TDcvIWMzwLC25wkZTGLSm_qhgn7PkrAGsrSUNSYndI0XvWaI_fOUaEbRTVmnyv_QdFpDiiaJvg14QghEuY5irfc5Uq5N8siPKFDr8P_VitecN455CUBAAA">
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"type":"Column","children":[{"name":"slider_a","type":"Slider","min":0.0,"max":100.0,"value":50.0,"disabled":false},{"name":"slider_b","type":"Slider","min":0.0,"max":100.0,"value":50.0,"disabled":false},{"type":"Watch","key":"slider_a","onChange":{"action":"setState","key":"total","value":"{{ slider_a + slider_b }}"}},{"type":"Watch","key":"slider_b","onChange":{"action":"setState","key":"total","value":"{{ slider_a + slider_b }}"}},{"type":"Watch","key":"total","onChange":{"action":"showToast","message":"Total updated: {{ total }}"}}]},"state":{"slider_a":50.0,"slider_b":50.0}}} playground="H4sIAP9SuGkC_62QsQrCMBCG9z7FkSnFInVwETL5CC04lmub2kCTK-1VBfHdjdWIguJilly4__suSTOQhX7QDZbFZJZYsSE3grE9DQyZ5oyRdQJZS8eccOSoeScq8lGnHT-hLXWTdR7pTK2HBHbIVRtFR8PtoyfjTQR-3RPSodVKjPOhQJGANU6lfsOTWqW-OGA3abVO469U-ZOabyFfp5ArqhbdXqvwTCmYGDvfE-czhCgsQlnC5SLiT77yX74AvMjCz0uR35ow9bV31xvwzjn-sFwB-luA1csBAAA">
<CodeGroup>
```python Python icon="python"
