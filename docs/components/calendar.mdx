...
<ComponentPreview auto json={`{"type":"Row","gap":6,"children":[{"type":"Calendar","mode":"single","name":"selectedDate"},{"type":"Column","gap":2,"children":[{"type":"Text","content":"Selected date:"},{"type":"Text","content":"{{ selectedDate | date:long }}","bold":true},{"content":"Raw: {{ selectedDate }}","type":"Muted"}]}]}`}>
<CodeGroup>
```python Python
