...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Column","children":[{"name":"switch_7","type":"Switch","label":"Default size","checked":true,"size":"default","disabled":false,"required":false},{"name":"switch_8","type":"Switch","label":"Small size","checked":true,"size":"sm","disabled":false,"required":false}]},"state":{"switch_7":true,"switch_8":true}}}>
<CodeGroup>
```python Python icon="python"
