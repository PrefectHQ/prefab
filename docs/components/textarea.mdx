...
<ComponentPreview json={{"view":{"name":"textarea_1","type":"Textarea","placeholder":"Enter your message...","disabled":false,"required":false}}}>
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Feedback"},{"name":"textarea_2","type":"Textarea","placeholder":"Tell us what you think...","rows":5,"disabled":false,"required":false}]}}}>
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"name":"textarea_3","type":"Textarea","value":"This is some initial content that can be edited.","rows":4,"disabled":false,"required":false},"state":{"textarea_3":"This is some initial content that can be edited."}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Textarea
...
<ComponentPreview json={{"view":{"name":"textarea_4","type":"Textarea","placeholder":"This textarea is disabled","disabled":true,"required":false}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Textarea
...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Column","children":[{"name":"textarea_5","type":"Textarea","placeholder":"Describe your journey through the galaxy...","rows":4,"disabled":false,"required":false},{"content":"Character count: {{ textarea_5 | length }}","type":"Text"}]}}}>
<CodeGroup>
```python Python icon="python"
