...
<ComponentPreview auto json={`{"label":"Refresh Data","variant":"default","size":"default","disabled":false,"onClick":{"action":"callTool","tool":"get_latest_data","arguments":{}},"type":"Button"}`} />

```python Call Tool Hero
