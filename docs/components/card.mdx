...
<ComponentPreview json={{"view":{"cssClass":"p-6","type":"Card","children":[{"content":"Quick Stats","type":"H3"},{"content":"42 active connections, 3 pending requests.","type":"P"}]}}} playground="H4sIAL1FuGkC_y2LMQ7CMBAEe7_i5MqRTAqCKJCoaFKCeEBknAtYkLPxneH7WAnb7Ei7M-U4Q8o4udtQQuvjnCIhCUOolAWMgpqTy6NdqO_WPlvVKPUN8lhG45kH_3LMR502e90c_m-jLyX4J1zFCetmdY3ebcF5CR8EH4mwYiS20EFCGgPdIeO7IAu31fkBEZltu6UAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card,
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 grid-cols-3","type":"Grid","children":[{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardDescription","content":"Revenue"},{"type":"CardTitle","content":"$12,450"}]}]},{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardDescription","content":"Users"},{"type":"CardTitle","content":"1,234"}]}]},{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardDescription","content":"Uptime"},{"type":"CardTitle","content":"99.9%"}]}]}]}}} playground="H4sIAL1FuGkC_22QwQrCMAyG73uKMBRaKKJuHiZ4UtCz6ElE5pZpwbUj7fT17TrcdJhTku9PyJ-CdAkVYZFeL7WcZLqstEJlDUiXkQUWgIt1Srnosh2mOVJfH6R9YF9u0GQkKyu1aptbkm6aB8FL2ruvWKYfdanMKhJwS6tVzJdeWWgC67dB7raAVHDyoAkW7vGJqsZQQDiazUW8mIZcfPGjQTINnYl5FA-YO6j0o0kyScYfeF52Gn9dY4DxvvkDWuND_Mc38yb4X5n_Fmvs8eANmLDAMn8BAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card,
