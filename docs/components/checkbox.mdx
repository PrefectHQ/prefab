...
<ComponentPreview json={{"view":{"cssClass":"gap-4 items-center","type":"Row","children":[{"name":"checkbox_9","value":true,"type":"Checkbox","label":"Enable Infinite Improbability Drive","disabled":false,"required":false},{"type":"Label","text":"Drive status:"},{"name":"input_2","value":"{{ checkbox_9 ? 'Engaged' : 'Disengaged' }}","type":"Input","inputType":"text","disabled":false,"readOnly":true,"required":false}]},"state":{"checkbox_9":true}}} playground="">
<CodeGroup>
```python Python icon="python"
