...
<ComponentPreview json={{"view":{"cssClass":"gap-3 items-center","type":"Row","children":[{"type":"Button","label":"-","variant":"outline","size":"default","disabled":false,"onClick":{"action":"setState","key":"count","value":"{{ count - 1 }}"}},{"content":"{{ count }}","type":"Text"},{"type":"Button","label":"+","variant":"outline","size":"default","disabled":false,"onClick":{"action":"setState","key":"count","value":"{{ count + 1 }}"}}]},"state":{"count":0}}} playground="H4sIALNZt2kC_6WOzW7CMAzH73kKK6dUFATiNqmXPQLsXnlRCtaKHaXuQEJ996VFBQHH-WT5__Fzk-QEMYUGv-ueVhgj0ClKUuiC1sSkhG3dKWowzbPXSzZyYO3myGevKlzCTs4lfIWLvkbQKwnf_fug-6nZvMGcl561WhfGnEmPY6U7YKy2JWBLB66sz-SQbPFhIM8N7ezSlvCLiTCHrfTaEod8Eq59S_6nmpHOToAs2esVph2WsIFhsEUxNY7_u4c4Ck-kxT9IizvpD3GawUiAAQAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"name":"slider_24","type":"Slider","min":0.0,"max":100.0,"value":50.0,"disabled":false},{"content":"Volume: {{ slider_24 }}%","type":"Text"},{"type":"Progress","value":"{{ slider_24 }}","min":0,"max":100,"variant":"default"}]},"state":{"slider_24":50.0}}} playground="H4sIALNZt2kC_z3NTQrCMBAF4H1OMRSEBEKJiJtCVl6goLiVqJMaaJIySbUg3t3-6WxmFt97Yyl66AituV56V96i72LAkBO48aIMh9j2PkioKTaEKUk4tu6OJOGEQ2bs5fJjRbwxnd6JisE4aVagV86fpu1R75UE74Kelhn0Vikx66mL2-I89WAF7yVd0vDZFIv4_V-L_kCwLwwpKzDDAAAA">
<CodeGroup>
```python Python icon="python"
