...
<ComponentPreview json={{"view":{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardTitle","content":"Q4 Revenue"},{"type":"CardDescription","content":"{{ revenue | currency }}"}]},{"type":"CardContent","children":[{"cssClass":"gap-2","type":"Column","children":[{"type":"Progress","value":"{{ revenue / target * 100 }}","min":0,"max":100.0,"variant":"default"},{"cssClass":"gap-2 items-center","type":"Row","children":[{"content":"{{ revenue / target | percent:1 }} of target","type":"Text"},{"type":"Badge","label":"{{ growth | percent:1 }} YoY","variant":"secondary"}]}]}]}]},"state":{"revenue":2847500,"target":3000000,"growth":0.124}}} playground="H4sIAL5FuGkC_31SPU_DMBDd8ytOnmxkhbQUgZCyUAZGqLowVSa5pJYSO7o4_RDiv-PYLWqoxA2WfR_vvbtzRbaFjrBSn5tBp6rrQLedJQc9uo022mnVbHqnHCbVNLewPtGgcf25hCfg7VmVNUpYKirjubTG-bT4eMG-IN05bY0M6aPzFVWJFBPW2jVjuW2G1kh4I1sT9r2Eld1LWOPByUQkSZAE-bVMTrhDM2A-f1w83GeZBKeoRpffZcEk1GT3bptn6Wy-8Eh77baBmYunoOjXEWWd3WexQSBn7wtYRSYmJvGLDnlQlJ4UpcVAhKY4ciGmRKcJXTLFWBgCr1WXzy9io53nwneq8c1OmeAW4ju2DjcwyzIhoVWHfLxNkAKTH26kkaAaXZucFV4QEvtDO9q4A16xr385RdohjRh8Jr7BVqctMHEFF_7LiBfL43Ym1R_2g0nYKdLKuJz1WFhTKjp6sB-dM2s4wAIAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardTitle","content":"Team Standup"},{"type":"CardDescription","content":"{{ starts | date:long }}"}]},{"type":"CardContent","children":[{"cssClass":"gap-2 items-center","type":"Row","children":[{"type":"Badge","label":"{{ starts | time }}","variant":"outline"},{"content":"{{ starts | datetime }}","type":"Text"}]}]}]},"state":{"starts":"2025-01-15T14:30:00Z"}}} playground="H4sIAL5FuGkC_2WQsW6EMAyGd54iyhQkDgHtLSex9Dp0bpm6IBcMtQRJFEyvj98Qygl0HizF-ez_tztnRmEddvBVz5SCtYJGaxyLCbkmTUww1BMDY9Qd2cZ4UKPmaWtRkfDxAm2PibiCa9d8NZo9tj5ecWocWSajk4AvxTeEFt0KVMSDb383t0RU-MtJFEdRMCDKR1PKZ8dTKYusOJ-y_JSfq_z58pRdsuxT-s4b8XeYq-JL0LsXVtGtvFkJ8kpWCKP4YNDtbP2YPbHbQAUP6eohbRc_cjC6l3F81Po_wV4s_PktVQ-2LBIBA_W6lI3H0MkdeL_pUY1pRBUn4gccgeZSmpkH0rhzu8Rywkeba3Mc_QE_ksk0_wEAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import set_initial_state
from prefab_ui.components import (
...
<ComponentPreview json={{"view":{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardTitle","content":"{{ name | upper }}"}]},{"type":"CardContent","children":[{"cssClass":"gap-2","type":"Column","children":[{"type":"Badge","label":"{{ name | lower }}","variant":"secondary"},{"content":"{{ bio | truncate:80 }}","type":"Text"}]}]}]},"state":{"name":"Arthur Dent","bio":"A perfectly ordinary man who woke up one Thursday to discover his house was about to be demolished, his planet destroyed, and his best friend was an alien from Betelgeuse."}}} playground="H4sIAL5FuGkC_2VRwW6DMAy98xUWJ5AQmnaaJnFYt8M-oPfKEFOihThKTBl_vyS0VavlgMjze8_O8-h5BudpxP606BadAz079gKB5KStFo3mFASFivGZO3AkWrISbpKqgHgOqM7UwCd6tX8_2Uqk7ZdvQkV-_z9qMYnJZpltA0f6laaoiyK3g-7_CHsDizN15YeXafHwFZ3LJuO95giDIz_SIGYD9kpb9BvMaGGdGFb-IVgcxLHhGNVB4QbCoHQY-EIeJh1g4iVQmR1LWDEA9rxIovUEimY2OkwU35bIzqAliXAQz1tC0apc6SMEo9dk1ZOZBTQRhJzmgYTMmWLDtsxPX7VMOZuqfs-qO7AHd4PTuUdY5XDalEu7OJdY9bP4uoJH9V7L0VdndN3rQ-2-xkdnw2tybuCCXqOVrgw0sFUx4LJ-kqZFXpVxJ634xQ5pe28vca4_dg6zpXICAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import set_initial_state
from prefab_ui.components import (
...
<ComponentPreview json={{"view":{"cssClass":"gap-2","let":{"greeting":"Don't Panic","name":"Arthur"},"type":"Column","children":[{"content":"{{ greeting }}, {{ name }}","type":"Text"},{"let":{"name":"Ford"},"type":"Column","children":[{"content":"{{ greeting }}, {{ name }}","type":"Text"}]}]}}} playground="H4sIAL5FuGkC_42NsQrCQBBE-3zFso0JHBaWgRSiWFvYyxk3yUFuL6wbFEL-3Ts1YulWs8PMm0aCh0GosZfz6NZ18ENgYr2Bi0oUdqEfPRs40UOz7O60-1h5a4dqY6AnrSZshUgdt1gC7gOvFI6WXY0GkK2nZG9Fu1FwLsoM4iVgjtMESxXm2UD8Uz5qLF6x38X31MI7BLl-aX8Sn4f01zrvAAAA">
<CodeGroup>
```python Python icon="python"
