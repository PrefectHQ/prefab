...
<ComponentPreview json={{"view":{"cssClass":"gap-6","type":"Column","children":[{"type":"Tabs","variant":"default","defaultValue":"one","children":[{"type":"Tab","title":"Mostly","value":"one","disabled":false,"children":[{"content":"Don't panic.","type":"Text"}]},{"type":"Tab","title":"Harmless","value":"two","disabled":false,"children":[{"content":"It's a wholly remarkable book.","type":"Text"}]}]},{"type":"Tabs","variant":"line","defaultValue":"one","children":[{"type":"Tab","title":"Mostly","value":"one","disabled":false,"children":[{"content":"Don't panic.","type":"Text"}]},{"type":"Tab","title":"Harmless","value":"two","disabled":false,"children":[{"content":"It's a wholly remarkable book.","type":"Text"}]}]}]}}}>
<CodeGroup>
```python Python icon="python"
