...
<ComponentPreview json={{"view":{"type":"Popover","children":[{"type":"Button","label":"Archive","variant":"outline","size":"default","disabled":false},{"cssClass":"gap-2","type":"Column","children":[{"type":"Text","content":"Archive this item?"},{"type":"Button","label":"Confirm","variant":"default","size":"default","disabled":false,"onClick":[{"action":"toolCall","tool":"archive_item","arguments":{"id":"{{ item_id }}"}},{"action":"closeOverlay"}]}]}]}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Button, Column, Popover, Text
from prefab_ui.actions import CloseOverlay, ToolCall
...
with Popover():
    ...
    with Column(gap=2):
        ...
        Button(
            "Confirm",
            on_click=[
                ToolCall("archive_item", arguments={"id": "{{ item_id }}"}),
                CloseOverlay(),
            ],
        )
```
