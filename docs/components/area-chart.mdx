...
<Card icon="braces" title="AreaChart Protocol">
<ParamField body="cssClass" type="string | null">
  CSS/Tailwind classes for styling
</ParamField>

<ParamField body="type" type="AreaChart" default="AreaChart">
...
<ParamField body="series" type="array" required>
  Series to render as areas
</ParamField>

<ParamField body="xAxis" type="string | null">
  Data key for x-axis labels
</ParamField>
...
<ParamField body="stacked" type="boolean" default="false">
  Stack areas
</ParamField>

<ParamField body="curve" type="string" default="linear">
  Line interpolation style. One of: `"linear"`, `"smooth"`, `"step"`
</ParamField>
