...
<ComponentPreview auto json={`{"view":{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardTitle","content":"{{ name }}"}]},{"type":"CardContent","children":[{"cssClass":"gap-1","type":"Column","children":[{"type":"Text","content":"Role: {{ role }}"},{"type":"Text","content":"The Answer to Everything: {{ answer }}"}]}]}]},"state":{"name":"Arthur Dent","role":"Reluctant Adventurer","answer":42}}`}>
<CodeGroup>
...
<ComponentPreview auto json={`{"view":{"cssClass":"gap-2","type":"Column","children":[{"type":"Text","content":"{{ name }}"},{"type":"Badge","label":"{{ role }}","variant":"secondary"},{"type":"Input","inputType":"text","placeholder":"Message {{ name }}...","disabled":false,"required":false}]},"state":{"name":"Zaphod Beeblebrox","role":"President of the Galaxy"}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Badge,
