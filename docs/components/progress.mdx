...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Progress","value":60.0,"max":100}}`}>
<CodeGroup>
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"cssClass":"gap-4","type":"Column","children":[{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"3 of 5 steps"},{"type":"Progress","value":3.0,"max":5.0}]},{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"75%"},{"type":"Progress","value":75.0,"max":100}]}]}}`}>
<CodeGroup>
```python Python icon="python"
