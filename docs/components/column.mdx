...
<Tab title="gap=8">
<ComponentPreview json={{"view":{"cssClass":"gap-8 p-3 border-3 border-dashed","type":"Column","children":[{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"}]}}} playground="H4sIABtduGkC_72MQQrCMBBF9z3F0FULjUREEKGreo-SdKZtIMmESaLXtwtBT-BfPT68twoHSEKrsXN1p4VD4kixZHAHSYGJfQ1xgId7Ns3Llf3zdJtJ422AJed58SbnsU3qApYFSb6AJu-EbX9v4NgR6X4EuykKJMajumoNwjUioQoIuzrrtv-b8wZRjSGYBgEAAA">
<CodeGroup>
```python Python highlight={3} icon="python"
from prefab_ui.components import Column, Div
...
<Tab title="gap=12">
<ComponentPreview json={{"view":{"cssClass":"gap-12 p-3 border-3 border-dashed","type":"Column","children":[{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"}]}}} playground="H4sIABtduGkC_72MTQrCMBBG9z3FkFULjaSKG6ErvUdJMtM2kD8mqV7fLAQ9gd_q8cF7K6cAmWnVZjncyaaQU6RYC7hGXOGe_BHiCA_37LqXq_vn6Ted5-k8gi1lsV6XMossL2ASI_EXUJedUAy3Dtpapf8RzCYpEGuP8qoUcDoiEsqAsMtJieFvzhtbJzZCBwEAAA">
<CodeGroup>
```python Python highlight={3} icon="python"
from prefab_ui.components import Column, Div
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 items-start p-3 border-3 border-dashed","type":"Column","children":[{"cssClass":"bg-emerald-500 rounded-md h-10 w-full","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10 w-3/4","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10 w-1/2","type":"Div"}]}}} playground="H4sIABtduGkC_53MzQqDMBAE4LtPseSkYKpWexE8te8h0UQN5I_dpL5-cyi0Z-c0DHyzobcQUG1imZO-rd4G75SLBDo3jPD0JllXw0u_i-LU8fgu5S7CNNQgjN7dxCgKjKyGlWhejSCaWOA9LB6lwl-Rgg4lWTUWkJM_yz-w7FxZhcJI_mhbQJ-cVJJbCQfvWjj5loxh1SXaN8NF2TX3LD8ZjR8OKAEAAA">
<CodeGroup>
```python Python highlight={3} icon="python"
from prefab_ui.components import Column, Div
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 items-center p-3 border-3 border-dashed","type":"Column","children":[{"cssClass":"bg-emerald-500 rounded-md h-10 w-full","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10 w-3/4","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10 w-1/2","type":"Div"}]}}} playground="H4sIABtduGkC_53MzQqDMBAE4LtPseSkYKpWexE8te8hMVk1kD82pr5-cyi0Z-c0DHyzkrcQCFexzEnfpLfBO3RHBJ0bHfD0JllXw0u_i-LUx_5dyk2EaahBGL25iclskFgNMsZZGhHjxALvYfGkkH5FibijYtVYQE4-Lf_AsnG0SMIo_mhbIJ-cQsWtgp13LZx8Tcaw6hLtm-Gi7Jp7lh-dDV6xKQEAAA">
<CodeGroup>
```python Python highlight={3} icon="python"
from prefab_ui.components import Column, Div
