...
<ComponentPreview json={{"view":{"type":"DropZone","multiple":false,"disabled":false,"name":"dropzone-1"}}}>
<CodeGroup>
...
{
  "view": {"type": "DropZone", "multiple": false, "disabled": false, "name": "dropzone-1"}
}
```
</CodeGroup>
</ComponentPreview>
...
<ComponentPreview json={{"view":{"type":"DropZone","icon":"image","label":"Drop images here","description":"PNG, JPG, or GIF up to 10MB","multiple":false,"disabled":false,"name":"dropzone-2"}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DropZone
...
<ComponentPreview json={{"view":{"type":"DropZone","label":"Upload documents","description":"PDF, DOCX, or TXT","accept":".pdf,.docx,.txt","multiple":false,"disabled":false,"name":"dropzone-3"}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DropZone
...
<ComponentPreview json={{"view":{"type":"DropZone","label":"Upload files","description":"Select as many as you like","multiple":true,"disabled":false,"name":"dropzone-4"}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DropZone
...
<ComponentPreview json={{"view":{"type":"DropZone","label":"Uploads disabled","multiple":false,"disabled":true,"name":"dropzone-5"}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DropZone
