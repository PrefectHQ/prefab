...
<Tabs>
<Tab title="columns=2">
<ComponentPreview auto json={`{"cssClass":"gap-4 grid-cols-2","type":"Grid","children":[{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"}]}`}>
<CodeGroup>
```python {3} Python
...
<Tab title="columns=4">
<ComponentPreview auto json={`{"cssClass":"gap-4 grid-cols-4","type":"Grid","children":[{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10","type":"Div"}]}`}>
<CodeGroup>
```python {3} Python
from prefab_ui.components import Div, Grid
...
For the complete protocol schema, see the [Grid protocol definition](/protocol/grid).
