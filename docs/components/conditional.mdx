...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"cssClass":"gap-2 items-center","type":"Row","children":[{"name":"showDetails","type":"Switch","checked":false,"size":"default","disabled":false,"required":false},{"content":"Show details","type":"Text"}]},{"type":"Condition","cases":[{"when":"{{ showDetails }}","children":[{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardTitle","content":"Project Details"}]},{"type":"CardContent","children":[{"content":"Heart of Gold \u2014 Infinite Improbability Drive","type":"Text"}]}]}]}],"else":[{"type":"Badge","label":"Details hidden","variant":"secondary"}]}]},"state":{"showDetails":true}}} playground="H4sIAAAAAAAC_3VSy07DMBC85ytWPjlSxAFuSLnQIsgN0d6jbbxujBw7ctyG3vgIvpAvwXVSklDIabKP2dlZS2cbaB1J3JUHdYNtC6pprfPQkS-VUV6hLjuPnhK5rK1sKDRkfHdp4QmE7wHFnrIIV-jEhFbW-FA-BZ4JBbnpf6u8vnRafWjMgF9tP4BNr3xVD3hL74Ep_V9UgMY7q0upbX9R-Kg7yqCQSRJXgvx6Td7Vtl-TR6W7fOsOlCZJmFuPkvge2_wuvY8iYjzIi8HbDFCrvclZFeaTY2PRpJwbbChnswEs_Sk5L8TZJuRALJJxSCF5VHcza57xDwKDhXwWXCQGr3-nF85z9uLsG1UertUtuMZD_kU2bBGGBbOthCerBXx9fEJh5NllgqJpnd3hTmnlT7B26kjzPc8HmvPGx8TZKAhqJQQZlsERnULjg5kU7izQnQLLN70KhInNAgAA">
<CodeGroup>
```python Python icon="python"
