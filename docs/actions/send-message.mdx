...
<ComponentPreview json={{"view":{"type":"Button","label":"Summarize","variant":"default","size":"default","disabled":false,"onClick":{"action":"sendMessage","content":"Please summarize the data above."}}}}>
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"type":"Input","inputType":"text","placeholder":"Ask a follow-up question...","name":"input-3","disabled":false,"required":false},{"type":"Button","label":"Ask","variant":"default","size":"default","disabled":false,"onClick":{"action":"sendMessage","content":"{{ input-3 }}"}}]}}}>
<CodeGroup>
```python Python icon="python"
...
with Column(gap=3):
    question_input = Input(placeholder="Ask a follow-up question...")
    Button("Ask", on_click=SendMessage(question_input.rx))
```
```json Protocol icon="brackets-curly"
{
  "view": {
