...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"name":"slider_21","type":"Slider","min":0.0,"max":100.0,"value":50.0,"disabled":false},{"content":"Volume: {{ slider_21 }}%","type":"Text"},{"type":"Progress","value":"{{ slider_21 }}","min":0,"max":100,"variant":"default"}]},"state":{"slider_21":50.0}}} playground="H4sIAAAAAAACEz3NTQrCMBAF4H1OMRSEBEKJiJtCVl6goLiVqJMaaJIySbUg3t3-6WxmFt97Yyl66AituV56V96i72LAkBO48aIMh9j2PkioKTaEKUk4tu6OJOGEQ2bs5fJjRbwxnd6JisE4aVagV86fpu1R75UE74Kelhn0Vikx66mL2-I89WAF7yVd0vDZFIv4_V-L_kCwLwwpKzDDAAAA">
<CodeGroup>
```python Python icon="python"
