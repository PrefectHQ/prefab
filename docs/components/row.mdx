...
<ComponentPreview json={{"view":{"cssClass":"gap-4 items-baseline p-3 border-3 border-dashed","type":"Row","children":[{"cssClass":"bg-emerald-500 rounded-md px-3 py-1 text-white text-sm","content":"Small","type":"Span"},{"cssClass":"bg-emerald-500 rounded-md px-3 py-2 text-white text-2xl","content":"Large","type":"Span"},{"cssClass":"bg-emerald-500 rounded-md px-3 py-1 text-white text-base","content":"Medium","type":"Span"}]}}} playground="">
<CodeGroup>
```python Python highlight={3} icon="python"
