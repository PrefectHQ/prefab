...
<ComponentPreview auto height="400px" json={`{"type":"Column","gap":3,"children":[{"cssClass":"items-center","type":"Row","gap":4,"children":[{"type":"DatePicker","placeholder":"Select deadline","name":"deadline"},{"type":"Text","content":"{{ deadline | date:long }}","bold":true}]}]}`}>
<CodeGroup>
```python Python
