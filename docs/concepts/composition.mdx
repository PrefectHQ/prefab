...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"cssClass":"justify-between","type":"Row","children":[{"type":"Label","text":"Volume"},{"content":"{{ slider_20 / 100 | percent }}","bold":true,"type":"Text"}]},{"name":"slider_20","type":"Slider","min":0,"max":100,"value":75.0,"disabled":false}]},"state":{"slider_20":75.0}}} playground="">
<CodeGroup>
```python Python icon="python"
    ...
    "children": [
      {
        ...
        "children": [
          ...
          {"content": "{{ slider_20 / 100 | percent }}", "bold": true, "type": "Text"}
        ]
      },
      {
        "name": "slider_20",
