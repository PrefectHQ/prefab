...
<ComponentPreview height="200px" json={{"view":{"type":"HoverCard","openDelay":0,"closeDelay":200,"children":[{"type":"Badge","label":"Healthy","variant":"default"},{"cssClass":"gap-2","type":"Column","children":[{"content":"weather-api","type":"Text"},{"content":"Uptime: 99.97%","type":"Muted"}]}]}}} playground="H4sIABtduGkC_0VOywqDMBC8-xVLoBAhFfFSFHqpFy-9tWdJddVAXsRY6983pkLnso_ZmdnBGQXW4cBf7SKyzihrNGo_gwid83Dj_YgMaiMXpRk05o2u5q5ncF88hvLAj0-SVfjpT1JjUbc9Sr5dcwadNDMeY5HnaZVAQHSmpEEu_bSRNC6jzy-Mjtxei-N4x55EyYrcT-jO3IpDsyM-Q8nTeqGwgrLMyssp8F_4hWZf4AAAAA">
<CodeGroup>
```python Python icon="python"
