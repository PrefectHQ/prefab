...
<ComponentPreview height="400px" json={{"view":{"cssClass":"w-fit mx-auto","name":"datepicker_1","type":"DatePicker","placeholder":"Select deadline"}}} playground="H4sIAL5FuGkC_0XGwQ3CMAwAwH-msPICibJBfwyAxACVcRxh4cRR7IqODz_udXVagzG54nPb5UrWhnXu4SC_zYAbBt-F3jxT-v80FIlfpoXnmh-sTAGFsah0zhcg940U3df8WaoEtGPBPSyf0xcKyiEScgAAAA">
<CodeGroup>
