...
<ComponentPreview json={{"view":{"type":"Button","label":"Upload File","variant":"default","size":"default","disabled":false,"onClick":{"action":"openFilePicker","multiple":false}}}} playground="H4sIALNZt2kC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUnEpLSvLzuNJQ1SUml2Tm58EV-Rek5rll5qQGZCZnpxZxcUE0aSiFFuTkJ6YogKSUdBTy8-KTc4AqbFGVa2hqcgEAuYEODYcAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"type":"Button","label":"Upload CSV","icon":"upload","variant":"outline","size":"default","disabled":false,"onClick":{"onSuccess":{"action":"toolCall","tool":"process_csv","arguments":{"file":"{{ $event }}"}},"action":"openFilePicker","accept":".csv","multiple":false}}}} playground="H4sIALNZt2kC_3WQywrCMBBF9_mKEFwoSD9AyEbBrYKPbYljKsF0JuTRTem_m76ULpxNhjv33BlSeaq587pSjzKZAqh2hBpj4CZ3PvJ9ipGQVUufgmgIv6aT03g0Vp8NvLX_Yy5qcDNwUNZeiSxjY_6a8Vzi5iypJz9c7mI7KAYIpUiDPEmN8kZhlIJStAb1JBOWYPN6ubxlDO5LAWiXsQJCMzETF1IehSDno37McJTz1I_LJTdE-leq-8-SrajySrHjom35SjdZ5F0nup9_M7b52bAP38yvDnUBAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Button
from prefab_ui.actions import OpenFilePicker
