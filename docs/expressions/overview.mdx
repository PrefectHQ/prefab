...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"name":"slider_23","type":"Slider","min":0.0,"max":100.0,"value":50.0,"disabled":false},{"content":"Volume: {{ slider_23 }}%","type":"Text"},{"type":"Progress","value":"{{ slider_23 }}","variant":"default"}]},"state":{"slider_23":50.0}}} playground="">
<CodeGroup>
```python Python icon="python"
...
```json Protocol icon="brackets-curly"
{
  "view": {
    ...
    "children": [
      ...
      {"type": "Progress", "value": "{{ slider_23 }}", "variant": "default"}
    ]
  },
