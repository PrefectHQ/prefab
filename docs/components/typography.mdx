...
<ComponentPreview json={{"view": {"cssClass": "gap-2", "type": "Column", "children": [{"content": "Regular paragraph text.", "type": "P"}, {"content": "This is bold.", "bold": true, "type": "P"}, {"content": "This is italic.", "italic": true, "type": "P"}, {"type": "Text", "content": "Bold and italic combined.", "bold": true, "italic": true}]}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    P,
