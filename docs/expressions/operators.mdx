...
<ComponentPreview auto json={`{"view":{"cssClass":"gap-2","type":"Column","children":[{"cssClass":"gap-3 items-center","type":"Row","children":[{"type":"Switch","checked":false,"size":"default","name":"active","disabled":false,"required":false},{"type":"Text","content":"{{ active ? 'Online' : 'Offline' }}"}]}]},"state":{"active":true}}`}>
<CodeGroup>
```python Python icon="python"
