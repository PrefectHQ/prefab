...
<ComponentPreview height="200px" json={{"view":{"type":"HoverCard","openDelay":0,"closeDelay":200,"children":[{"type":"Badge","label":"Healthy","variant":"default"},{"cssClass":"gap-2","type":"Column","children":[{"content":"weather-api","type":"Text"},{"content":"Uptime: 99.97%","type":"Muted"}]}]}}}>
<CodeGroup>
```python Python icon="python"
