...
<ComponentPreview json={{"view":{"type":"Alert","variant":"default","children":[{"type":"AlertTitle","content":"Heads up!"},{"type":"AlertDescription","content":"You can add components to your app using the CLI."}]}}} playground="H4sIAAAAAAACE22OMQvCMBSE9_yKs1MKpT_ATXRQcHRxkti82gdtXkheEP-9AQeLeNN3HHfcmGRBTDS6-61wP8gSJVDQDK6UFNagajdT0u6LF9aZVv5AeUgclSV0pjXmyTp9Ettuf2q2OZLzGSVumvbvhG2uUjC4AOc9Vp9U8JKS4GJEyRwe0ImwP5_6uvQGVqIEDcsAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Column","children":[{"type":"Alert","variant":"default","icon":"circle-alert","children":[{"type":"AlertTitle","content":"Heads up!"},{"type":"AlertDescription","content":"You can add components to your app using the CLI."}]},{"type":"Alert","variant":"destructive","icon":"circle-x","children":[{"type":"AlertTitle","content":"Error"},{"type":"AlertDescription","content":"Your session has expired. Please log in again."}]},{"type":"Alert","variant":"success","icon":"circle-check","children":[{"type":"AlertTitle","content":"Success"},{"type":"AlertDescription","content":"Your changes have been saved successfully."}]}]}}} playground="H4sIAAAAAAACE5WPQUsDQQyF7_0VcU5bqD15EnqQWlDwIOjFk6Sz6W5wdmZIZmr7753WxXYXCjan5L0kvG8joYMotMH1Z-a5DV0MnnxS4NJJgmoCpR4cSZqd2kdSKxwTB3-mvnNy9Dsvg8td8aaTyTentp-rBuPibnp_XDnqx7uKbfALY1mso1s8SKZfGv6uzBNhrZDjjZkO_bNE1Z9zKPMRMlj0gHUNZ3wpwD5kAYwRzPAiK_sGUkuwfHmen8wCMwq-RWH0aWFq0iTZJt6SmcGAZ3eJZSUS5CoOASXVYkGLCrSLLFTP4dURKoELzZiEC3aD7P8Hodna8n8MYFuyX5cg3vqb6zBsi74hLRhbgjWRBy1dPY7fB9pk5_YDhB8l0DZBtwIAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Alert,
...
<ComponentPreview json={{"view":{"type":"Alert","variant":"default","children":[{"type":"AlertDescription","content":"Your changes have been saved."}]}}} playground="H4sIAAAAAAACE23KMQrDMAyF4V2nEJlsCDlAt0IvkSk4rlILGsnISnr9Gjpk6Zs-eP9mumM12tK6HDxl3asKiTfkLnMMgH33N5mPFx_UsnF1VhkhAnzYy-8J8fY3C8Osh2EuSV7UsKSTcCUSbF3PaYjwBfhj99WLAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Alert,
