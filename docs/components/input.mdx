...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Input","inputType":"text","placeholder":"Enter your email...","disabled":false,"required":false}}`}>
<CodeGroup>
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Email address"},{"type":"Input","inputType":"email","placeholder":"you@example.com","disabled":false,"required":true}]}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Column,
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Input","inputType":"text","placeholder":"Disabled input","disabled":true,"required":false}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Input
...
For the complete protocol schema, see the [Input protocol definition](/protocol/input).
