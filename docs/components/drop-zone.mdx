...
<ComponentPreview json={{"view":{"name":"dropzone_1","type":"DropZone","multiple":false,"disabled":false}}} playground="H4sIAAAAAAAC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUXIryC6KAQlxcMJaGJhcA8fV4vTYAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"name":"dropzone_2","type":"DropZone","icon":"image","label":"Drop images here","description":"PNG, JPG, or GIF up to 10MB","multiple":false,"disabled":false}}} playground="H4sIAAAAAAAC_zWLwQrCMBBE7_mKISeFIvoBvYhYFJSevUgat7rQZMMm_X_TQucwDG9mRpWApDS64T3zwUtIEimWDK5JCy4q6VWRMVvaGVSxl9haDu5LtlnJ5AaaWrvMsPKMH-nWfih75VR4ufXPrsG9ryaK7nbFnFAEp-PjXOd78wcq8kIIlgAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DropZone
...
<ComponentPreview json={{"view":{"name":"dropzone_4","type":"DropZone","label":"Upload files","description":"Select as many as you like","multiple":true,"disabled":false}}} playground="H4sIAAAAAAAC_zWKMQ4CMQwE-7zCSgXSiR-k4wdAQ4NyOUeycGLLSYr7_QUE2-xodrNJATXMcX0NuiQpKhVrb0CTrMPVRJ9TOfenk4MZjity8A9liRtkYmx--S4btmSknaQGf0PG1CE2KLHun95lANMbf-8yuJMyhrsNXNzZHUq59v6SAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DropZone
...
<ComponentPreview json={{"view":{"name":"dropzone_5","type":"DropZone","label":"Uploads disabled","multiple":false,"disabled":true}}} playground="H4sIAAAAAAAC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUXIryC6KAQlxcMJZGTmJSao6tUmhBTn5iSrFCSmZxYlJOaoqSDpxpG1JUmqrJBQBeS9maXQAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import DropZone
