---
title: Components
description: Building UIs from components — what they are, how they nest, and how Python's with statement maps to the component tree.
icon: puzzle-piece
---
