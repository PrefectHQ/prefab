...
<ComponentPreview json={{"view":{"cssClass":"w-fit","name":"select_2","type":"Select","placeholder":"Choose size...","size":"default","disabled":false,"required":false,"invalid":false,"children":[{"type":"SelectOption","value":"sm","label":"Small","selected":false,"disabled":false},{"type":"SelectOption","value":"md","label":"Medium","selected":false,"disabled":false},{"type":"SelectOption","value":"lg","label":"Large","selected":false,"disabled":false}]}}} playground="H4sIABtduGkC_33MwQqDMAwG4LtPUXJScH2AQU-7buzgA0itUQOpLU2dsKdfD4K7bLnkJ3x_phS8igknO_QbaRd8DCuuWRSVlLLqkNHl9tjPmCmsVbVTXo5THdk6XAKPmAzclhAEldAbtdbQKifSO7YiBvbLRBmaa6XKfP-rX5Y3NCC-FNgOyAY6b5mh-Wn9eNoHjrT5P5jnE99tmrHYD9WXJpD6AAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"w-fit mx-auto","name":"select_3","type":"Select","placeholder":"Select country","size":"default","disabled":false,"required":false,"invalid":false,"children":[{"type":"SelectOption","value":"us","label":"United States","selected":false,"disabled":false},{"type":"SelectOption","value":"uk","label":"United Kingdom","selected":true,"disabled":false},{"type":"SelectOption","value":"ca","label":"Canada","selected":false,"disabled":false}]}}} playground="H4sIABtduGkC_3WNvQrCMBCA9z5FyNRC6wMImRwdHKpzuSZXG8wfycXq2xu0oCC95Y4Pvu-m6C0LEScYh6x30tvgHTpKTJcrEuvRoKR23adA2ruqWjTNK6qDAYmzNwqj4B_GpM-O4pO3TKY0SAMpCb50kyZmHx1k8rzZV6zMb7e-g8koeE5FNDCiEfziNKFiPQFh4s22c_tzjtpdlbeFp7eASpxjxu2GhG_jAA4UlIcvuFU36CIBAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Select, SelectOption
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 w-fit min-w-[200px] mx-auto","type":"Column","children":[{"name":"select_4","type":"Select","placeholder":"Default size","size":"default","disabled":false,"required":false,"invalid":false,"children":[{"type":"SelectOption","value":"1","label":"Option 1","selected":false,"disabled":false},{"type":"SelectOption","value":"2","label":"Option 2","selected":false,"disabled":false}]},{"name":"select_5","type":"Select","placeholder":"Small size","size":"sm","disabled":false,"required":false,"invalid":false,"children":[{"type":"SelectOption","value":"1","label":"Option 1","selected":false,"disabled":false},{"type":"SelectOption","value":"2","label":"Option 2","selected":false,"disabled":false}]}]}}} playground="H4sIABtduGkC_72OPwvCMBDF936KI1MLrdjiJGTS3aGjSEnj1QYuf2gSK356q1UQhI7e8g7uvXe_brAa3ICdaJuoVtJqZw2a4EFN2xBgZylqk0ONhDJ89OCCsiZJRhX6tyW9CMc3OUjvG0nCe87GolMBtDLFWByr9drdTqBvhYjBsmybwDSvgrkzdSQk9pbOOHC2n5AiBfDqjh_zc77_p1dBETkrWQ4kWiTO5gOULFtMVD-JakosE9VaEM08-Us48_pfaA_HAyhaqAEAAA">
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"cssClass":"w-fit mx-auto","name":"select_7","type":"Select","placeholder":"Travel class...","size":"default","disabled":true,"required":false,"invalid":false,"children":[{"type":"SelectOption","value":"first","label":"First Class","selected":false,"disabled":false},{"type":"SelectOption","value":"business","label":"Business","selected":false,"disabled":false},{"type":"SelectOption","value":"economy","label":"Economy","selected":false,"disabled":false}]}}} playground="H4sIABtduGkC_3WNuw6DMAxFd74iygQSzQdUytKqXTuUHSXBiEgmRnlA-_cFSh8LXmwf3WO3nno2eGiVrpMVhvqBHLgYmJ0nH9kdEEwst34boiWXZZON3YbyjM01oDLQETbgJa-8GgGZQRWCEIKXa6SxQWmERlY-wRuZEOo1Jfl0aG1k_eOgUqTZKI5r4v9tPipMIHlrfYi8ZKg0oOTXZWXn5QwvdiWdgnUwR77e6UP2JTDkqH_-nMsGiuwFBesumjkBAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Select, SelectOption
...
<ComponentPreview json={{"view":{"cssClass":"w-fit mx-auto","name":"select_8","type":"Select","placeholder":"Choose a ship...","size":"default","disabled":false,"required":false,"invalid":false,"children":[{"type":"SelectOption","value":"heart_of_gold","label":"Heart of Gold","selected":false,"disabled":false},{"type":"SelectOption","value":"bistromath","label":"Bistromath","selected":false,"disabled":true},{"type":"SelectOption","value":"vogon_ship","label":"Vogon Constructor Fleet","selected":false,"disabled":false},{"type":"SelectOption","value":"starship_titanic","label":"Starship Titanic","selected":false,"disabled":true}]}}} playground="H4sIABtduGkC_42PwWrDMBBE7_6KxacYHH9AwZcG2t56SOhVrOV1JJC1Rlon_fxKrqAFp9C5SLwdjWanwDMsgSYc1Go7zfPCnrxEsOkWBM7kSEtbzvdFLPuqulsxBR0qSFocajLsRgp9fTLMkQAhGrt0XVe3m0fHqLTDGPv6fpyswPx5xFU4jZunzfH7k8MN3Up9bQiDKJ7UNaXXLTgcyPX1W8bAE7xm3OyfbySr5Aw2SloWxZQ6WSXs-dFstBEHR2N_CSt94-bPlje-sld535-KH5nBiX0KX7VwgBdHJP8pGwVDDlNiBb3V-8rn4oDLzvGw-BeXIPTh6QEAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Select, SelectOption
...
<ComponentPreview json={{"view":{"cssClass":"gap-2 w-fit mx-auto","type":"Column","children":[{"type":"Label","text":"Destination"},{"name":"select_9","type":"Select","placeholder":"Choose a planet...","size":"default","disabled":false,"required":false,"invalid":true,"children":[{"type":"SelectOption","value":"magrathea","label":"Magrathea","selected":false,"disabled":false},{"type":"SelectOption","value":"betelgeuse","label":"Betelgeuse V","selected":false,"disabled":false},{"type":"SelectOption","value":"vogsphere","label":"Vogsphere","selected":false,"disabled":false}]}]}}} playground="H4sIABtduGkC_4WOu27DMAxFd38FockGHA8ZC2hpOrbo0CJrQCu0JUAvSFSSz6_spm6mlouIK55DTik4iIkmHE_FDCq4GDx5zmBqlxgOwRbne3jFkWwPH2RJ8c_7HtkE3zRXw_o-2c4Y5b4HlfNJWcxZiutuMgzutsPCQXRPDdRafa14oczG46IR3fqxur71bbSoSAd7piTFQYeQCRBq6omHYRA9GH9Ba87yMxW6m5d6PK-tE4WkcDgnZE1YMbtsl-Jti7o_0ZGY7Ewl0y_7vGVw_Ae_hDlHTemBPm5R13wB_EnLnoQBAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Column, Label, Select, SelectOption
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 w-fit mx-auto","type":"Column","children":[{"name":"select_11","type":"Select","placeholder":"Choose a planet...","size":"default","disabled":false,"required":false,"invalid":false,"children":[{"type":"SelectOption","value":"magrathea","label":"Magrathea","selected":false,"disabled":false},{"type":"SelectOption","value":"betelgeuse","label":"Betelgeuse V","selected":false,"disabled":false},{"type":"SelectOption","value":"vogsphere","label":"Vogsphere","selected":false,"disabled":false},{"type":"SelectOption","value":"earth","label":"Earth (Mostly Harmless)","selected":false,"disabled":false}]},{"content":"You chose: {{ select_11 }}","type":"Text"}]}}} playground="H4sIABtduGkC_4WQwWrDMAyG73kK4VMCaU47FXJZGexSdtgo7FQUT4kDdmwsuc0Ye_e5a5f21Oki-UOfMH8fvYMQqcdun8ZGexf8RJMwjHmKAhtvk5tqeCVLWv76S5DRZ_pGsxTFcRRzWSwHDO1DDZp5ry0yt-q46kcBN68wiVfVuoBcv8r5VhksajLeflBs1cZ4zwQImU4kTdOoCpCByZ7NU91-ojygTdQqh0NEMYSqBosd2VZtF1TdVTsSsgMlpqv7uDDY_aMf_MDBULyxdwu6rxJGMVft6fSEcutZ7Cc8Y3SWmKvLkVPYZa_efQJtckhr-MqpNHH-zgs_pmwppMkBAAA">
<CodeGroup>
```python Python icon="python"
