...
<ComponentPreview auto json={`{"view":{"cssClass":"gap-2","let":{"greeting":"Don't Panic","name":"Arthur"},"type":"Column","children":[{"type":"Text","content":"{{ greeting }}, {{ name }}"},{"let":{"name":"Ford"},"type":"Column","children":[{"type":"Text","content":"{{ greeting }}, {{ name }}"}]}]}}`}>
<CodeGroup>
