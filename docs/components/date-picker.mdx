...
{
  "view": {"type": "DatePicker", "placeholder": "Select deadline", "name": "deadline"}
}
```
</CodeGroup>
</ComponentPreview>
...
<ComponentPreview height="400px" json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"cssClass":"gap-4 items-center","type":"Row","children":[{"type":"DatePicker","placeholder":"Select deadline","name":"deadline"},{"content":"{{ deadline | date:long }}","bold":true,"type":"Text"}]}]},"state":{"deadline":"2025-06-15T12:00:00.000Z"}}}>
<CodeGroup>
```python Python icon="python"
    ...
    "children": [
      {
        ...
        "type": "Row",
        "children": [
          {"type": "DatePicker", "placeholder": "Select deadline", "name": "deadline"},
        ...
        "children": [
          {
            ...
            "children": [
              ...
              {"type": "DatePicker", "placeholder": "Pick a date", "name": "eventDate"}
            ]
          }
        ]
      },
