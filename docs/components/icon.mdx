...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Icon","name":"rocket","size":"default"}}`}>
<CodeGroup>
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"cssClass":"gap-4 items-center","type":"Row","children":[{"type":"Icon","name":"heart","size":"sm"},{"type":"Icon","name":"heart","size":"default"},{"type":"Icon","name":"heart","size":"lg"}]}}`}>
<CodeGroup>
```python Python icon="python"
