...
<Card icon="code" title="Carousel Parameters">
...
<ParamField body="css_class" type="str | None" default="None">
  Additional Tailwind CSS classes for the carousel container.
</ParamField>
</Card>
...
For the complete protocol schema, see [Carousel](/protocol/carousel).
