...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"cssClass":"justify-between","type":"Row","children":[{"type":"Label","text":"Volume"},{"content":"{{ slider-3 | number }}%","bold":true,"type":"Text"}]},{"type":"Slider","min":0,"max":100,"value":75.0,"name":"slider-3","disabled":false}]}}}>
<CodeGroup>
```python Python icon="python"
    ...
    "children": [
      {
        ...
        "children": [
          ...
          {"content": "{{ slider-3 | number }}%", "bold": true, "type": "Text"}
        ]
      },
      {
        "type": "Slider",
...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"cssClass":"justify-between","type":"Row","children":[{"type":"Label","text":"Rating"},{"content":"{{ slider-4 }}","bold":true,"type":"Text"}]},{"type":"Slider","min":0.0,"max":10.0,"value":5.0,"step":0.5,"name":"slider-4","disabled":false}]}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Column,
    ...
    "children": [
      {
        ...
        "children": [
          ...
          {"content": "{{ slider-4 }}", "bold": true, "type": "Text"}
        ]
      },
      {
        "type": "Slider",
...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Column","children":[{"type":"Slider","min":0,"max":100,"value":50.0,"name":"slider-5","disabled":false,"onChange":{"action":"setState","key":"level","value":"{{ $event }}"}},{"cssClass":"text-muted-foreground","content":"{{ level | default:'Drag the slider' }}","type":"Text"}]}}}>
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"type":"Slider","min":0,"max":100,"value":30.0,"name":"slider-6","disabled":true}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Slider
