...
<ComponentPreview json={{"view":{"type":"Switch","label":"Enable notifications","checked":false,"size":"default","name":"switch_5","disabled":false,"required":false},"state":{"switch_5":false}}}>
<CodeGroup>
...
<ComponentPreview json={{"view":{"type":"Switch","label":"Dark mode","checked":true,"size":"default","name":"switch_6","disabled":false,"required":false},"state":{"switch_6":true}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Switch
...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Column","children":[{"type":"Switch","label":"Default size","checked":true,"size":"default","name":"switch_7","disabled":false,"required":false},{"type":"Switch","label":"Small size","checked":true,"size":"sm","name":"switch_8","disabled":false,"required":false}]},"state":{"switch_7":true,"switch_8":true}}}>
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"type":"Switch","label":"Enabled switch","checked":false,"size":"default","name":"switch_9","disabled":false,"required":false},{"type":"Switch","label":"Disabled off","checked":false,"size":"default","name":"switch_10","disabled":true,"required":false},{"type":"Switch","label":"Disabled on","checked":true,"size":"default","name":"switch_11","disabled":true,"required":false}]},"state":{"switch_9":false,"switch_10":false,"switch_11":true}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Column,
