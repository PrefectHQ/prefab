...
<ComponentPreview json={{"view":{"type":"Textarea","placeholder":"Enter your message...","name":"textarea-1","disabled":false,"required":false}}}>
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Feedback"},{"type":"Textarea","placeholder":"Tell us what you think...","name":"textarea-2","rows":5,"disabled":false,"required":false}]}}}>
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"type":"Textarea","value":"This is some initial content that can be edited.","name":"textarea-3","rows":4,"disabled":false,"required":false}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Textarea
...
<ComponentPreview json={{"view":{"type":"Textarea","placeholder":"This textarea is disabled","name":"textarea-4","disabled":true,"required":false}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Textarea
