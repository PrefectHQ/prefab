...
<Card icon="code" title="Mermaid Parameters">
<ParamField body="chart" type="str" required>
  Mermaid diagram definition string. Supports all [Mermaid diagram types](https://mermaid.js.org/intro/syntax-reference.html). Can be passed as a positional argument.
</ParamField>
...
For the complete protocol schema, see [Mermaid](/protocol/mermaid).
