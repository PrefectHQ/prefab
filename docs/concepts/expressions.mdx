...
<ComponentPreview json={{"view":{"cssClass":"gap-3 items-center","type":"Row","children":[{"type":"Button","label":"-","variant":"outline","size":"default","disabled":false,"onClick":{"action":"setState","key":"count","value":"{{ count - 1 }}"}},{"type":"Badge","label":"{{ count }}","variant":"success"},{"type":"Button","label":"+","variant":"outline","size":"default","disabled":false,"onClick":{"action":"setState","key":"count","value":"{{ count + 1 }}"}}]},"state":{"count":0}}} playground="">
<CodeGroup>
...
```json Protocol icon="brackets-curly"
{
  "view": {
    ...
    "children": [
      ...
      {"type": "Badge", "label": "{{ count }}", "variant": "success"},
      {
        "type": "Button",
        "label": "+",
        "variant": "outline",
