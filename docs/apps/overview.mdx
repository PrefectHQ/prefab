...
description: Build interactive UIs that render directly inside MCP host applications.
icon: rocket
---
...
<ComponentPreview auto json={`{"gap":3,"type":"Column","children":[{"inputType":"text","placeholder":"Enter a city...","name":"city","disabled":false,"required":false,"type":"Input"},{"label":"Get Weather","variant":"default","size":"default","disabled":false,"onClick":{"action":"callTool","tool":"get_weather","arguments":{"location":"{{ city }}"}},"type":"Button"}]}`} />
...
<ComponentPreview auto json={`{"label":"Save","variant":"default","size":"default","disabled":false,"onClick":[{"action":"setState","key":"saving","value":true},{"action":"callTool","tool":"save_data","arguments":{"item":"{{ item }}"}},{"action":"setState","key":"saving","value":false}],"type":"Button"}`} />
...
<ComponentPreview auto json={`{"type":"Card","children":[{"type":"CardContent","children":[{"gap":3,"type":"Column","children":[{"inputType":"text","placeholder":"you@example.com","name":"email","disabled":false,"required":false,"type":"Input"},{"label":"Subscribe","variant":"default","size":"default","disabled":false,"type":"Button"}]}]}]}`} />
...
See the component reference pages in the sidebar for the full catalog, and the [Playground](/servers/apps/playground) to try components interactively.
