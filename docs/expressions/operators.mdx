...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"cssClass":"gap-2","type":"Row","children":[{"name":"first","type":"Input","inputType":"text","placeholder":"First name","disabled":false,"readOnly":false,"required":false},{"name":"last","type":"Input","inputType":"text","placeholder":"Last name","disabled":false,"readOnly":false,"required":false}]},{"content":"Hello, {{ first }} {{ last }}!","type":"Text"}]},"state":{"first":"Arthur","last":"Dent"}}} playground="H4sIAAAAAAACE22PMYsCMRCF-_yKMdUKwcLrDlKIcpxgJdcvczpxA9kkZGdRkP3vl4S18HS693jvmxmTQg8xkcHfdrQrjBFsH0NiGIhb6y1bdO3AyCTMc_YUctCT5-FR2QY39l7B3seRFRzDVcEP3ViICgD9Cm2MTQNruUncjUkqcFjkLmPlUoir5W7GNheM-mP5KSBP9TO_muvZLFNXNx570rKiMzI6PFEX3JmSll_FhBLI_HetcsD_0gGfO-Wpxshvci4ouNdPVnXd9FAFMy1y_g8O_ZHFYgEAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import set_initial_state
