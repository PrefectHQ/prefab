...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Button","label":"Save Changes","variant":"default","size":"default","disabled":false}}`}>
<CodeGroup>
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Button","label":"Unavailable","variant":"default","size":"default","disabled":true}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Button
