...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"let":{"_loop_7":"{{ $item }}","_loop_7_idx":"{{ $index }}"},"type":"ForEach","key":"crew","children":[{"cssClass":"gap-2 items-center","type":"Row","children":[{"content":"{{ _loop_7 }}","type":"Text"},{"type":"Button","label":"\u00d7","variant":"ghost","size":"sm","disabled":false,"onClick":{"action":"popState","key":"crew","index":"{{ _loop_7_idx }}"}}]}]},{"cssClass":"gap-2","type":"Row","children":[{"name":"new_member","type":"Input","inputType":"text","placeholder":"Crew member name...","disabled":false,"readOnly":false,"required":false},{"type":"Button","label":"Add","variant":"default","size":"default","disabled":false,"onClick":[{"action":"appendState","key":"crew","value":"{{ new_member }}"},{"action":"setState","key":"new_member","value":""}]}]},{"content":"{{ crew | length }} crew members","type":"Muted"}]},"state":{"crew":["Arthur Dent","Ford Prefect","Trillian"],"new_member":""}}} playground="H4sIAAAAAAACE21SzYrbMBC-6ynEnGQQPrS3gg_ptoUeCkt3b8titPLEFpUlIY-bpaXP0Qfqi1VSnGQdRxfLo2_m-2H20Y88RNyrl3Y2tQqBmzH4SHxCao0zZJRtJ1KEbL_Gap-ADh1Np5aPM5F3kt95O4_p-8XHz0oPkn91YSbJv82EneTf_UHyR3yl64lKk_HuPG4XArruIXNLfu_DcntAKjfGiizebKUKxtPREQ_NE-wiDXPkn5JSkBySqI7fJ07U5f8xGmuNcvAsS5fDQzvi-IKxAZCsYuxgaFg8iV6F5n31oSBLffEoILNBxVWSTzgeEWdUslxa30murOldAzrJwQjVBZhPTkXk_mpVPgYrVrV84N9fkJvqTxWTH2qgH_xENwCT-YUNTOONJ-9abY3-0ZzyXozJ4qruS9IdvopqrbBiW69vvJUFEE6NifcScJoarNI4eNvluO8SEz8-8Yyt6xouNLdCgF3XXbk4O3jamHuzUGdbZV_qi6Zqm8lp4cRaOsAV9pmt0yjrLvbw-8iRCWuLrqdBVH_Kdi5mp-TyP1lanEaJAwAA">
<CodeGroup>
