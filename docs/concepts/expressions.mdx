...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"name":"slider_21","type":"Slider","min":0.0,"max":100.0,"value":50.0,"disabled":false},{"content":"Volume: {{ slider_21 }}%","type":"Text"},{"type":"Progress","value":"{{ slider_21 }}","min":0,"max":100,"variant":"default"}]},"state":{"slider_21":50.0}}} playground="">
<CodeGroup>
```python Python icon="python"
