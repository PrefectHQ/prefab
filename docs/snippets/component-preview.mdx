      ...
      <Card>
        ...
        {playgroundHref && (
          <div style={{ display: "flex", justifyContent: "flex-end", padding: "4px 0 8px" }}>
            <a href={playgroundHref} target="_blank" rel="noopener noreferrer" style={{ fontSize: "11px", color: "color-mix(in srgb, var(--muted-foreground) 60%, transparent)", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "3px" }} onMouseOver={function(e) { e.currentTarget.style.color = "var(--muted-foreground)"; }} onMouseOut={function(e) { e.currentTarget.style.color = "color-mix(in srgb, var(--muted-foreground) 60%, transparent)"; }}>
              Open in Playground
