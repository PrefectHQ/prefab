...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Slider","min":0.0,"max":100.0,"value":50.0,"disabled":false}}`}>
<CodeGroup>
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Slider","min":0.0,"max":10.0,"value":5.0,"step":0.5,"disabled":false}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Slider
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Slider","min":0.0,"max":100.0,"value":30.0,"disabled":true}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Slider
...
For the complete protocol schema, see the [Slider protocol definition](/protocol/slider).
