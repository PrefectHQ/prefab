...
<ComponentPreview json={{"view":{"type":"Checkbox","label":"Accept terms and conditions","checked":false,"name":"checkbox_1","disabled":false,"required":false},"state":{"checkbox_1":false}}}>
<CodeGroup>
...
<ComponentPreview json={{"view":{"type":"Checkbox","label":"Subscribe to newsletter","checked":true,"name":"checkbox_2","disabled":false,"required":false},"state":{"checkbox_2":true}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Checkbox
...
<ComponentPreview json={{"view":{"cssClass":"gap-3 w-fit mx-auto","type":"Column","children":[{"type":"Checkbox","label":"Email notifications","checked":true,"name":"checkbox_3","disabled":false,"required":false},{"type":"Checkbox","label":"SMS notifications","checked":false,"name":"checkbox_4","disabled":false,"required":false},{"type":"Checkbox","label":"Push notifications","checked":true,"name":"checkbox_5","disabled":false,"required":false}]},"state":{"checkbox_3":true,"checkbox_4":false,"checkbox_5":true}}}>
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"cssClass":"gap-3 w-fit mx-auto","type":"Column","children":[{"type":"Checkbox","label":"Enabled option","checked":false,"name":"checkbox_6","disabled":false,"required":false},{"type":"Checkbox","label":"Disabled option","checked":false,"name":"checkbox_7","disabled":true,"required":false},{"type":"Checkbox","label":"Disabled & checked","checked":true,"name":"checkbox_8","disabled":true,"required":false}]},"state":{"checkbox_6":false,"checkbox_7":false,"checkbox_8":true}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Checkbox,
