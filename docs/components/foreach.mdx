...
<ComponentPreview json={{"view":{"cssClass":"gap-1 w-fit mx-auto","type":"Column","children":[{"content":"The Plan:","type":"H4"},{"let":{"_loop_6":"{{ $item }}","_loop_6_idx":"{{ $index }}"},"type":"ForEach","key":"steps","children":[{"content":"{{ _loop_6_idx + 1 }}. {{ _loop_6 }}","type":"Text"}]}]},"state":{"steps":["Collect underpants","???","Profit"]}}} playground="H4sIAL5FuGkC_3VPPWvDMBDd9SuOm2TqBAKZAsZDScmYIVsJ5qpKtUCWhHTGgZD_Htk4Qym95b7ee_fOpDBATNrQVzfaLcUIdoghMWTNnfWWLbkuM7EW5jdWhQL02nN-Ud6DGwdfw0XfuIbT_n9GKT2n4DrjwvSif4R0JNUL8ee0zKxjbj6xXHBaMYz-W6dIRQlrwLZt53ROwVjGayXEZLlf7cgfis2uBpVzpxzl3OC0KTgYbhsaOWB1EFDitJd46TWcHfkDVstskVltSVxMYAWUQdoa5nblzjE_LQ3eLbzB7rGF-7x_FKEnXbA6ZWMBAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import set_initial_state
