...
<ComponentPreview auto json={`{"view":{"cssClass":"p-6","type":"Card","children":[{"content":"Quick Stats","type":"H3"},{"content":"42 active connections, 3 pending requests.","type":"P"}]}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card,
...
<ComponentPreview auto json={`{"view":{"cssClass":"gap-4 grid-cols-3","type":"Grid","children":[{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardDescription","content":"Revenue"},{"type":"CardTitle","content":"$12,450"}]}]},{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardDescription","content":"Users"},{"type":"CardTitle","content":"1,234"}]}]},{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardDescription","content":"Uptime"},{"type":"CardTitle","content":"99.9%"}]}]}]}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card,
...
<Card icon="braces" title="Card Protocol">
...
<ParamField body="type" type="Card" default="Card">
  Component discriminator.
</ParamField>

</Card>

<Card icon="braces" title="CardHeader Protocol">
<ParamField body="cssClass" type="string | null">
  CSS/Tailwind classes for styling
</ParamField>
...
<ParamField body="type" type="CardHeader" default="CardHeader">
  Component discriminator.
</ParamField>

</Card>

<Card icon="braces" title="CardTitle Protocol">
<ParamField body="cssClass" type="string | null">
  CSS/Tailwind classes for styling
</ParamField>
...
<ParamField body="type" type="CardTitle" default="CardTitle">
  Component discriminator.
</ParamField>
...
<Card icon="braces" title="CardDescription Protocol">
<ParamField body="cssClass" type="string | null">
  CSS/Tailwind classes for styling
</ParamField>
...
<ParamField body="type" type="CardDescription" default="CardDescription">
  Component discriminator.
</ParamField>

<ParamField body="content" type="string | null">
  Description text (alternative to children)
</ParamField>

</Card>

<Card icon="braces" title="CardContent Protocol">
<ParamField body="cssClass" type="string | null">
  CSS/Tailwind classes for styling
</ParamField>
...
<ParamField body="type" type="CardContent" default="CardContent">
  Component discriminator.
</ParamField>

</Card>

<Card icon="braces" title="CardFooter Protocol">
<ParamField body="cssClass" type="string | null">
  CSS/Tailwind classes for styling
</ParamField>
...
<ParamField body="type" type="CardFooter" default="CardFooter">
  Component discriminator.
</ParamField>
