...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Button","label":"Use Advanced Mode","variant":"default","size":"default","disabled":false,"onClick":{"action":"updateContext","content":"User has selected advanced mode. Provide detailed technical responses."}}}`}>
<CodeGroup>
...
For the complete protocol schema, see the [UpdateContext protocol definition](/protocol/update-context).

<Card icon="braces" title="UpdateContext Protocol">
<ParamField body="action" type="updateContext" default="updateContext">
</ParamField>
...
<ParamField body="structuredContent" type="object | null">
  Structured content to add
</ParamField>
