...
For the complete protocol schemas, see [Table](/protocol/table), [TableHead](/protocol/table-head), [TableCell](/protocol/table-cell), and [TableCaption](/protocol/table-caption).
...
```json Table
{
  ...
  "cssClass?": "string",
  "visibleWhen?": "string",
  "children": [TableCaption | TableHeader | TableBody]
}
```

```json TableHead / TableCell
{
  "type": "TableHead | TableCell",
  "content?": "string",
  "cssClass?": "string",
  "visibleWhen?": "string",
  "children?": []
