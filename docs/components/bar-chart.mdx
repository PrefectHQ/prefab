...
<Card icon="braces" title="BarChart Protocol">
<ParamField body="cssClass" type="string | null">
  CSS/Tailwind classes for styling
</ParamField>

<ParamField body="type" type="BarChart" default="BarChart">
...
<ParamField body="horizontal" type="boolean" default="false">
  Render as horizontal bar chart
</ParamField>

<ParamField body="barRadius" type="number" default="4">
