...
<ComponentPreview json={{"view":{"type":"Button","label":"Save Changes","variant":"default","size":"default","disabled":false}}} playground="H4sIAAAAAAAC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUnEpLSvLzuLggtIZScGJZqoJzRmJeemqxkiYXAJHD65FAAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-3 items-center","type":"Row","children":[{"type":"Button","label":"Tiny","variant":"default","size":"xs","disabled":false},{"type":"Button","label":"Small","variant":"default","size":"sm","disabled":false},{"type":"Button","label":"Default","variant":"default","size":"default","disabled":false},{"type":"Button","label":"Large","variant":"default","size":"lg","disabled":false}]}}} playground="H4sIAAAAAAAC_12OuwoCMRBF-3xFSJVAtLET0oilldovMWbXQF5kJqz69UaR4DrVvZzDZcaSAs3FjvoyVLc2KeQUbUSgrqWClBPablcRU5SffEyzJIKQ2eHtXfiks9pIagAG4zWAYg5tgJVpO7Ywsf2Z4Ozs4oNJCu5pFbsDEwt6Ctr7jiH84X17tHrswvXbl9ZBl8l2x08NvwC2uWo26AAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Button,
...
<ComponentPreview json={{"view":{"cssClass":"gap-3 items-center","type":"Row","children":[{"type":"Button","label":"Download","icon":"download","variant":"default","size":"default","disabled":false},{"type":"Button","label":"Settings","icon":"settings","variant":"outline","size":"default","disabled":false},{"type":"Button","label":"Delete","icon":"trash-2","variant":"destructive","size":"default","disabled":false}]}}} playground="H4sIAAAAAAAC_13LTQqDMBAF4L2nCFkp2C7aXSGb4gnaA0gaRx3QGclM9PpVSu3PWz0e72sjj2aK0PpHnfAYeJyYgFQMri2quSZVptLceMmyBbXfWt75yZ1LE0TqMHgRZ1FhlENYKURbXDKz5mVzW_FCA_vGlgYDk7PNeyh-fndQRepk_8lnmH1ET-osJx2Q4I9WMIDCDjV66Q-nb9eAaExBcd7sEzMRjuX4AAAA">
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"cssClass":"gap-3 items-center","type":"Row","children":[{"type":"Button","label":"","icon":"plus","variant":"default","size":"icon-xs","disabled":false},{"type":"Button","label":"","icon":"plus","variant":"default","size":"icon-sm","disabled":false},{"type":"Button","label":"","icon":"plus","variant":"default","size":"icon","disabled":false},{"type":"Button","label":"","icon":"plus","variant":"default","size":"icon-lg","disabled":false}]}}} playground="H4sIAAAAAAAC_42MMQrDMAxFd59CaErA6dKt4KVH6AVCapxUYFvGsknp6avSC1jT_5_3tFdOUGrYt-fa6eI5Fc4hNwHSVBvce2ucLTz4NOak9vql6diKu1rwIquPm4hDaiHJ4lUNFeebAb2_OyFaIM_ZYYldtAh9gho6LW_BeZSVNMyOP42Hsl8xij7sBgEAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Button, Row
...
<ComponentPreview json={{"view":{"type":"Button","label":"Unavailable","variant":"default","size":"default","disabled":true}}} playground="H4sIAAAAAAAC_0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUnEpLSvLzuLggtIZSaF5iWWJmTmJSTqqSjkJKZjGIlWIbUlSaqskFALZ6C75OAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Button
...
<ComponentPreview json={{"view":{"cssClass":"gap-3 items-start w-full","type":"Column","children":[{"cssClass":"w-full bg-emerald-500","type":"Button","label":"Full Width Emerald","variant":"default","size":"default","disabled":false},{"cssClass":"rounded-full bg-rose-500","type":"Button","label":"Pill Shape Rose","variant":"default","size":"default","disabled":false}]}}} playground="H4sIAAAAAAAC_1XMPQuDMBAG4N1fcWRSMEUoXQouLe1c2qGjRBM1kC9yCf79HlVKvem9r2eM3kKIahR9l_Vh8DZ4p1xC0JRigrIAqktOybv6m6_eZEu5KopFp3nry0mE9ljDgNgNRiC2TCdlkWMSxCx8zMaw6vzHlexOM3hrScrNqiiMZDth_YJ-4mpd81PTsGpnPDRdvGYRFDw9qj0QfXZSyR8T6WIzPvfpsq_6AAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Button,
