...
<ComponentPreview json={{"view":{"type":"Field","invalid":"{{ !agree }}","disabled":false,"children":[{"type":"Label","text":"Terms and conditions"},{"name":"agree","type":"Checkbox","label":"I accept the terms of service","checked":false,"disabled":false,"required":false},{"type":"FieldError","content":"You must accept the terms to continue."}]}}} playground="H4sIAAAAAAAC_2WOwQrCQAxE7_2KuKctFD9A6EkUBE_FiyfZblMb7G5KNtV-vrUqHsxlBpI3k1Y4wCDYuvoy0tpzGDhi1AQ0O1HYduhvNU8F7An75iM7EZYCjq7GvoBqyrIHaffeWYp311NTVpM1K3cVRJPnmwzmWQBrTighgYsNeI4NKXFMJl8uvn02uoCleeMF9C-wNAdw3uOgoB2CLincQkK5k8dPwu9Ba848QhiT_mPKr26lOOJ6Bp9swG_HCAEAAA">
<CodeGroup>
```python Python icon="python"
