...
<ComponentPreview json={{"view":{"name":"textarea_1","type":"Textarea","placeholder":"Enter your message...","disabled":false,"required":false}}} playground="H4sIABtduGkC_zXGMQ6AIAwF0J1TNE66cANHb-BuKn6UBCgpkOjtdfFNz6skKgrP-9aDdZKKZORWKXzTRivuxgo25t9YIjtcEg_oPCy5QemRrpRQK5-w1g6TeQGkDFZhWQAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Feedback"},{"name":"textarea_2","type":"Textarea","placeholder":"Tell us what you think...","rows":5,"disabled":false,"required":false}]}}} playground="H4sIABtduGkC_1WMPQvCMBRF9_yKR6YGSgbBRegkODl2L6_tqwlN80I-qP57qxXFO50L594p8gIh0oR9V6weeAnsyecEdqOYoRKw5cyuLL5-8xV7cju2dM8YCWuhhFhtNh-xumFoDur08yt5IRp7HGap_qb7_yvB4UCG3UixkS05ByXBajDDgwtkY_2stZb1dxB5Tc1x70o8ARHp9DDKAAAA">
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"name":"textarea_3","type":"Textarea","value":"This is some initial content that can be edited.","rows":4,"disabled":false,"required":false},"state":{"textarea_3":"This is some initial content that can be edited."}}} playground="H4sIABtduGkC_zWMMQ6DQAwEe79iRRUkRJWWX9AjcxhhibPRnUny_JwiZaopZncvnnEV2Xldbh2T58tNLCq0WQnM8gkuwkR_exAaLz5vmbr50JZWVM8CNQ3lE8kt2gfi4EBiwyqQTUO2sRt-6-LvOj0H6ukLpeoZ3YEAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Textarea
...
<ComponentPreview json={{"view":{"name":"textarea_4","type":"Textarea","placeholder":"This textarea is disabled","disabled":true,"required":false}}} playground="H4sIABtduGkC_z3JSwqAIBAA0L2nGFwVRDfwFu5j1BEFf4wKHT8X1e7B81wzNCaP5prxtDW3WqiMDnGJB2i6BzKhEJ-2ltBSqMkRK6lD7DDegmUXO5pETh4_leZJu3gAXer8NGwAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Textarea
