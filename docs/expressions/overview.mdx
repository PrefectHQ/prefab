...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"type":"Slider","min":0.0,"max":100.0,"name":"volume","disabled":false},{"content":"Volume: {{ volume }}%","type":"Text"},{"type":"Progress","value":"{{ volume }}","min":0,"max":100,"variant":"default"}]},"state":{"volume":50}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import set_initial_state
