...
<ComponentPreview auto json={`{"cssClass":"items-center","type":"Row","gap":4,"children":[{"type":"Icon","name":"heart","size":"sm"},{"type":"Icon","name":"heart","size":"default"},{"type":"Icon","name":"heart","size":"lg"}]}`}>
<CodeGroup>
```python Python
...
<ComponentPreview auto json={`{"type":"Column","gap":3,"children":[{"cssClass":"items-center","type":"Row","gap":2,"children":[{"type":"Icon","name":"check","size":"sm"},{"type":"Text","content":"Task completed"}]},{"cssClass":"items-center","type":"Row","gap":2,"children":[{"type":"Icon","name":"clock","size":"sm"},{"type":"Text","content":"Waiting for approval"}]},{"cssClass":"items-center","type":"Row","gap":2,"children":[{"type":"Icon","name":"circle-x","size":"sm"},{"type":"Text","content":"Build failed"}]}]}`}>
<CodeGroup>
```python Python
