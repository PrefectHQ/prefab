...
<ComponentPreview json={{"view":{"cssClass":"gap-4","type":"Row","children":[{"cssClass":"bg-emerald-500 rounded-md h-10 w-24","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10 w-24","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10 w-24","type":"Div"}]}}} playground="H4sIAAAAAAACE0srys9VKChKTUtMii_N1EvOzy3Iz0vNKylWyASyikoUXDLLdBSC8su5uMozSzJALI30xAJbE00rLgUgAEprJBcXxyfnJBYX2yolpeum5qYWJeak6JoaGCgU5ZfmpaSm6OamKGToGhoolOsamShpDoBGAHJoVwfnAAAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 w-auto","type":"Column","children":[{"cssClass":"bg-emerald-500 rounded-md h-10 w-24","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10 w-24","type":"Div"},{"cssClass":"bg-emerald-500 rounded-md h-10 w-24","type":"Div"}]}}} playground="H4sIAAAAAAACE8WLOw7DIBAFe06xorIlb0Qip4nkKrmHhQHbSMAiPuH6oUiRG2Sqp3maPZGHmMwut7XaiyIfKZhQMti-UoEnuerDBC_7ZqzZcn7NcMi4zBOonFflZM4LbyhrIT4-GHR6MPyc24HGmySdxrsQkKgGbTR6DSdeBTS8zXz8Q_gBua1djwEBAAA">
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 w-auto","type":"Column","children":[{"cssClass":"gap-4","type":"Row","children":[{"cssClass":"bg-blue-500 rounded-md h-10 w-24","type":"Div"},{"cssClass":"bg-blue-500 rounded-md h-10 w-24","type":"Div"},{"cssClass":"bg-blue-500 rounded-md h-10 w-24","type":"Div"}]},{"cssClass":"bg-purple-500 rounded-md h-10","type":"Div"}]}}} playground="H4sIAAAAAAACE8XMTQrCMBAF4H1PMXTVQiJV6kboqp7AC5SkSdtAkgn5Mdc3aheC7n2r4fG-WTwacF4ujE9JHWY0Dq20MYAql48wok7GEriqO4Eb5qrKKm573azMDT2BOYRp1iyEoc6UpYh1e6mg5LUt6j3cy2fKu-ZD8ZVynSQ9dx14TFZIQY2AjR47yPTU1-3f5LdyyTv90xXyABsDvEJRAQAA">
<CodeGroup>
```python Python icon="python"
...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"cssClass":"justify-between","type":"Row","children":[{"type":"Label","text":"Volume"},{"cssClass":"font-bold","content":"{{ slider_20 / 100 | percent }}","type":"Text"}]},{"name":"slider_20","type":"Slider","min":0,"max":100,"value":75.0,"disabled":false}]},"state":{"slider_20":75.0}}} playground="H4sIAAAAAAACE1VPywrCMBC85yuWnhKI9QEiCDl59aTiVZJ2q5G0KXm09e9NWxWc0zDMzsxWztbQOqykukWdF7ZubYNN8KATcwEO1sS64XCUCg2Hk-05nI0u0XG44BBI9Z_ghu_laSCkswZEYtTIWpVyD90Yh4yQXofHJ5zeZSs2bE8gYdJTCy28vxVGei-yZ_RBV6-FwtAjNtnHOmKaRbPrFJuxnz5Oo3SsX8J6tWJ5i65If1HGQVlTiouLONvnSWnm_BbtpIkodltG3gMzNZEdAQAA">
<CodeGroup>
```python Python icon="python"
