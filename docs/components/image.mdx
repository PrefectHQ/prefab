...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Image","src":"https://picsum.photos/400/300","alt":"Example image","width":"400px"}}`}>
<CodeGroup>
...
For the complete protocol schema, see the [Image protocol definition](/protocol/image).
