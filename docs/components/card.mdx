...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"cssClass":"p-6","type":"Card","children":[{"content":"Quick Stats","type":"H3"},{"content":"42 active connections, 3 pending requests.","type":"P"}]}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card,
