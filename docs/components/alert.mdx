...
<ComponentPreview auto json={`{"view":{"type":"Alert","variant":"default","children":[{"type":"AlertTitle","content":"Heads up!"},{"type":"AlertDescription","content":"You can add components to your app using the CLI."}]}}`}>
<CodeGroup>
...
<ComponentPreview auto json={`{"view":{"type":"Alert","variant":"default","children":[{"type":"AlertDescription","content":"Your changes have been saved."}]}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Alert,
...
<ParamField body="icon" type="string | null">
  Lucide icon name (kebab-case, e.g. 'circle-alert')
</ParamField>
