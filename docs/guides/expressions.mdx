...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"name":"slider_22","type":"Slider","min":0.0,"max":100.0,"value":50.0,"disabled":false},{"content":"Volume: {{ slider_22 }}%","type":"Text"},{"type":"Progress","value":"{{ slider_22 }}","min":0,"max":100,"variant":"default"}]},"state":{"slider_22":50.0}}}>
<CodeGroup>
```python Python icon="python"
