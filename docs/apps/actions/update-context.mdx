...
<ComponentPreview auto json={`{"label":"Use Advanced Mode","variant":"default","size":"default","disabled":false,"onClick":{"action":"updateContext","content":"User has selected advanced mode. Provide detailed technical responses."},"type":"Button"}`} />
...
<ComponentPreview auto json={`{"gap":3,"type":"Column","children":[{"placeholder":"Thinking level...","name":"thinking","size":"default","disabled":false,"required":false,"type":"Select","children":[{"value":"low","label":"Low","selected":false,"disabled":false,"type":"SelectOption"},{"value":"medium","label":"Medium","selected":false,"disabled":false,"type":"SelectOption"},{"value":"high","label":"High","selected":false,"disabled":false,"type":"SelectOption"}]},{"label":"Set Preference","variant":"default","size":"default","disabled":false,"onClick":{"action":"updateContext","structuredContent":{"preference":{"thinking":"{{ thinking }}"}}},"type":"Button"}]}`} />
