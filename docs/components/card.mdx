...
<ComponentPreview json={{"view":{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardTitle","content":"Create project"},{"type":"CardDescription","content":"Deploy your new project in one-click."}]},{"type":"CardContent","children":[{"content":"Your project will be created with default settings.","type":"P"}]},{"type":"CardFooter","children":[{"type":"Button","label":"Cancel","variant":"outline","size":"default","disabled":false},{"type":"Button","label":"Deploy","variant":"default","size":"default","disabled":false}]}]}}} playground="H4sIALNZt2kC_2VQMW7DMAzc_QpCkw24eUCBLnVQdMyQpVOhyEzLViENmaqR31e1IttBNZGn45F35yAXGAKe7ek90s7JZRBG1hEoVUGhriC9zoa-XapXtD2GtT-SelzbPY4u0KAkvIKdsCbdFXgR0SLyHFUL-dBWTVVNpJ8zrW4eZ3gB8vIC351Qmy6gVUyG5AudmuaOs7mrNnscvFzhKjEA41RGgBhSAA_Ok_ve3QSW3TcT2-WH2rz9aZT5ibyHE4KbL-nzbJ_yjV5hRFXij_GfcA5jq5sjSY4sO_SmhR8byLI-GYnqiXFjrnCzp_TxCyK7cynWAQAA">
<CodeGroup>
...
<ComponentPreview json={{"view":{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardTitle","content":"Account Settings"},{"type":"CardDescription","content":"Manage your account preferences and security."}]},{"type":"CardContent","children":[{"content":"Update your display name, email, and notification preferences from this panel.","type":"P"},{"content":"Changes take effect immediately.","type":"Muted"}]},{"type":"CardFooter","children":[{"type":"Button","label":"Save changes","variant":"default","size":"default","disabled":false}]}]}}} playground="H4sIALNZt2kC_2WRzWrDMAzH730K4ZMDpQ_Q25YxdikUup2H5sitWCIHW9nI28_Nd5kvlmTpr58lH0MDbSSPX58dH1xo2iAkmoCzFRXsDvIpMVb7xXojrCiu_jtrTav7QslFbpWDrMEyiGbdNfAags4iz53qnHwer1OnlFsWu90v622osMVxeFoCI8ccfqCx5sm50InChVRZrskUD1kbSGtOKHgl6EMXAae6-1AokjhKgFJBItdF1v4wCS0U08-2GGdrPtoKdZKsOLU19iDY0B6oQa73g6YEZc8O7xQPDf19LXrjBC0K1YcN_DAYa8obyjVnKn4TkPfkNK-soYpz2_o_5TjuLeQ4dGsu-EPgRrlc9Qd2dysqEgIAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card,
...
<ComponentPreview json={{"view":{"cssClass":"p-6","type":"Card","children":[{"content":"Quick Stats","type":"H3"},{"content":"42 active connections, 3 pending requests.","type":"P"}]}}} playground="H4sIALNZt2kC_y2LMQ7CMBAEe7_i5MqRTAqCKJCoaFKCeEBknAtYkLPxneH7WAnb7Ei7M-U4Q8o4udtQQuvjnCIhCUOolAWMgpqTy6NdqO_WPlvVKPUN8lhG45kH_3LMR502e90c_m-jLyX4J1zFCetmdY3ebcF5CR8EH4mwYiS20EFCGgPdIeO7IAu31fkBEZltu6UAAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card,
...
<ComponentPreview json={{"view":{"cssClass":"gap-4 grid-cols-3","type":"Grid","children":[{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardDescription","content":"Revenue"},{"type":"CardTitle","content":"$12,450"}]}]},{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardDescription","content":"Users"},{"type":"CardTitle","content":"1,234"}]}]},{"type":"Card","children":[{"type":"CardHeader","children":[{"type":"CardDescription","content":"Uptime"},{"type":"CardTitle","content":"99.9%"}]}]}]}}} playground="H4sIALNZt2kC_22QwQrCMAyG73uKMBRaKKJuHiZ4UtCz6ElE5pZpwbUj7fT17TrcdJhTku9PyJ-CdAkVYZFeL7WcZLqstEJlDUiXkQUWgIt1Srnosh2mOVJfH6R9YF9u0GQkKyu1aptbkm6aB8FL2ruvWKYfdanMKhJwS6tVzJdeWWgC67dB7raAVHDyoAkW7vGJqsZQQDiazUW8mIZcfPGjQTINnYl5FA-YO6j0o0kyScYfeF52Gn9dY4DxvvkDWuND_Mc38yb4X5n_Fmvs8eANmLDAMn8BAAA">
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import (
    Card,
