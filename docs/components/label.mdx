...
<ComponentPreview json={{"view":{"type":"Label","text":"Email address"}}}>
<CodeGroup>
...
<ComponentPreview json={{"view":{"cssClass":"gap-2","type":"Column","children":[{"type":"Label","text":"Username","forId":"username"},{"name":"username","type":"Input","inputType":"text","placeholder":"Enter username","disabled":false,"readOnly":false,"required":false}]}}}>
<CodeGroup>
```python Python icon="python"
