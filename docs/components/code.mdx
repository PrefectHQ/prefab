...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"type":"Code","content":"def answer() -> int:\\n    \\"\\"\\"Return the Answer to the Ultimate Question\\n    of Life, the Universe, and Everything.\\"\\"\\"\\n    return 42","language":"python"}}`}>
<CodeGroup>
...
<ComponentPreview auto json={`{"$protocol":"prefab","view":{"cssClass":"gap-3","type":"Column","children":[{"type":"Code","content":"pip install prefab-ui","language":"bash"},{"type":"Code","content":"SELECT name, designation\\nFROM crew\\nWHERE ship = 'Heart of Gold';","language":"sql"},{"type":"Code","content":"{ \\"ship\\": \\"Heart of Gold\\", \\"drive\\": \\"Infinite Improbability\\" }","language":"json"}]}}`}>
<CodeGroup>
```python Python icon="python"
...
For the complete protocol schema, see the [Code protocol definition](/protocol/code).
