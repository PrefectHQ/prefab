...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"type":"Slider","min":0.0,"max":100.0,"value":50.0,"name":"slider-7","disabled":false},{"content":"Volume: {{ slider-7 }}%","type":"Text"},{"type":"Progress","value":"{{ slider-7 }}","min":0,"max":100,"variant":"default"}]}}}>
<CodeGroup>
```python Python icon="python"
...
```json Protocol icon="brackets-curly"
{
  "view": {
    ...
    "children": [
      ...
      {"content": "Volume: {{ slider-7 }}%", "type": "Text"},
      {
        "type": "Progress",
        "value": "{{ slider-7 }}",
        "min": 0,
