...
<ComponentPreview auto json={`{"view":{"type":"ButtonGroup","orientation":"horizontal","children":[{"type":"Button","label":"Save","variant":"default","size":"default","disabled":false},{"type":"Button","label":"Cancel","variant":"outline","size":"default","disabled":false}]}}`}>
<CodeGroup>
...
<ComponentPreview auto json={`{"view":{"type":"ButtonGroup","orientation":"vertical","children":[{"type":"Button","label":"Top","variant":"default","size":"default","disabled":false},{"type":"Button","label":"Middle","variant":"outline","size":"default","disabled":false},{"type":"Button","label":"Bottom","variant":"outline","size":"default","disabled":false}]}}`}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.components import Button, ButtonGroup
...
<Card icon="braces" title="ButtonGroup Protocol">
...
<ParamField body="type" type="ButtonGroup" default="ButtonGroup">
  Component discriminator.
</ParamField>

<ParamField body="orientation" type="string" default="horizontal">
  Layout direction: horizontal or vertical. One of: `"horizontal"`, `"vertical"`
</ParamField>
