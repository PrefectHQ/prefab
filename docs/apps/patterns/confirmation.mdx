...
<ComponentPreview auto json={`{"type":"Popover","children":[{"type":"Button","label":"Archive","variant":"outline","size":"default","disabled":false},{"type":"Column","gap":2,"children":[{"type":"Text","content":"Archive this item?"},{"type":"Button","label":"Confirm","variant":"default","size":"default","disabled":false,"onClick":{"action":"toolCall","tool":"archive_item","arguments":{"id":"{{ item_id }}"}}}]}]}`} />
