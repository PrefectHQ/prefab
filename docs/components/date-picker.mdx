...
<ComponentPreview height="400px" json={{"view":{"cssClass":"gap-6 items-center","type":"Row","children":[{"name":"datepicker_2","type":"DatePicker","placeholder":"When does the whale arrive?"},{"cssClass":"gap-2 justify-center","type":"Column","children":[{"type":"Label","text":"Selected date"},{"content":"{{ datepicker_2 ? (datepicker_2 | date:long) : 'None yet' }}","italic":true,"type":"Text"}]}]}}} playground="">
<CodeGroup>
```python Python icon="python"
