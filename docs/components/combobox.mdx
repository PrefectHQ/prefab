...
For the complete protocol schema, see [Combobox](/protocol/combobox), [ComboboxOption](/protocol/combobox-option), [ComboboxGroup](/protocol/combobox-group), [ComboboxLabel](/protocol/combobox-label), [ComboboxSeparator](/protocol/combobox-separator).
