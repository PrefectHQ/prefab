...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"type":"Input","inputType":"text","placeholder":"Your name","name":"name","disabled":false,"required":false},{"content":"Hello, {{ name }}!","type":"Text"}]},"state":{"name":"Arthur"}}}>
<CodeGroup>
```python Python icon="python"
from prefab_ui.app import set_initial_state
...
<ComponentPreview json={{"view":{"cssClass":"gap-3","type":"Column","children":[{"type":"Slider","min":0.0,"max":100.0,"value":50.0,"name":"slider_19","disabled":false},{"content":"Volume: {{ slider_19 }}%","type":"Text"},{"type":"Progress","value":"{{ slider_19 }}","min":0,"max":100,"variant":"default"}]},"state":{"slider_19":50.0}}}>
<CodeGroup>
```python Python icon="python"
